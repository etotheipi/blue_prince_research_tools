# Blue Prince Clean Corpus Export

Generated from curated clean_corpus.sqlite

## The 8 Red Letters

| # | Author                 | Recipient        | Location           | Summary                                                                                              |
|---|------------------------|------------------|--------------------|------------------------------------------------------------------------------------------------------|
| 1 | Worth Laude            | Herbert Sinclair | Rotating Gear      | Blackmail letter to HSS; knows secrets from own father's deathbed; offers silence for payment        |
| 2 | Caleb Manning          | Mary Jones       | Study              | Resistance planning — museum heist trial run using Mt. Holly's flexible floorplan                    |
| 3 | Unknown (not Caleb)    | Herbert Sinclair | Unknown (Orchard?) | The missing letter — unfindable per Alzara's Forecastings                                            |
| 4 | Daniel Jones           | Herbert Sinclair | Boudoir            | Mary's husband — furious Herbert covered up her disappearance; threatens Simon will learn the truth  |
| 5 | Mary Jones             | Herbert Sinclair | Drafting Studio    | Mary's farewell — departing north via mountain tunnels; asks Herbert to guide Simon to the Safehouse |
| 6 | Herbert Sinclair       | Mary Jones       | Drawing Room       | Herbert's goodbye — promises to protect Simon; "Farewell my Marigold"                                |
| 7 | Courtney (Ferrine?)    | Herbert Sinclair | Shelter            | Signed "Courtney"; language suggests a cousin; believes Herbert smuggled Mary after Ruby Crown theft |
| 8 | Denny Revane (implied) | Herbert Sinclair | Office             | Blackmailer's closing letter after ransom paid; warns Herbert to keep incriminating letters in safes |
...
| Natural# | Glass# | Name   | Common Name   | Paragon        | Headwear          | Tool            | Border Colors |
|----------|--------|--------|---------------|----------------|-------------------|-----------------|---------------|
| 1        | VII    | Orinda | Queen         | Royalty        | Crown             | Scepter, Shield | Black/White   |
| 2        | VI     | Lydia  | Equestrian    | Mastery        | Equestrian Helmet | Riding Crop     | Yellow/Black  |
| 3        | I      | Rynna  | Gardener      | Gardening      | Straw Hat         | Garden Hoe      | Green/Red     |
| 4        | II     | Joya   | Chef          | Cuisine        | Chef's Hat        | Peel            | Yellow/Violet |
| 5        | III    | Dauja  | Farmer        | Husbandry      | Cowboy Hat        | Pitchfork       | Red/Violet    |
| 6        | IV     | Veia   | Chimney Sweep | Ash            | Top Hat           | Chimney Brush   | Black/Red     |
| 7        | V      | Mila   | Maid          | Service        | White Bonnet      | Broom           | Violet/Grey   |
| 8        | ∞      | Draxus | Death         | Shade of Death | Hood              | Scythe, Effigy  | White/Grey    |
...
| Blessing     | Effect                                                                                     |
|--------------|--------------------------------------------------------------------------------------------|
| Dancer       | Pay 1 Gem while drafting to rotate floor plans                                             |
| High Roller  | Gain an Ivory Dice each time you draft a Shop; gain 5 Gold whenever you roll an Ivory Dice |
| Gardener     | Add 8 Courtyards to today's Draft Pool                                                     |
| Chef         | Each different type of spread today adds an extra dish to the Dining Room                  |
| Red General  | After drafting a Red Room, if you have 5+ different Ranks with Red Rooms, gain 5 Gems      |
| Tinkerer     | Whenever you draft a Mechanical room, trigger your current experiment                      |
| Monk         | If you Call it a Day in a room in the house, can draft that room outside the next day      |
| Berry Picker | While drafting, pick a berry to draft a random room from the pool regardless of rarity     |

---

## 5 Planets

| Planet   | Title (Planetarium) | Erajan Meaning        | Planetarium Effect      | Notes                                                   |
|----------|---------------------|-----------------------|-------------------------|---------------------------------------------------------|
| Mora     | Our Colorful World  | Earth/world           | +1 Prism Key per day    | The home planet                                         |
| Mamora   | Guiding Light       | "Small world/land"    | +1 Ivory Dice per day   | The small planet; where Ivory Dice spawns via Telescope |
| Fennmora | The Red Stone       | "Red world/land"      | +1 Apple per day        | Red planet; likely named after Fenn (red realm)         |
| Veia     | Dark Shadow         | Angel, Paragon of Ash | +1 Dig Spot per day     | Largest planet; shares name with Paragon of Ash angel   |
| Dauja    | The Untamed         | "The Last Day"        | +1 Locked Trunk per day | Name shared with angel Dauja, Paragon of Husbandry      |
...
| Piety of the Bishop    | You do not have to pay tithes. Instead, gain 30 Coins the first time you enter the Chapel each day with this power.                   |
| Banner of the King     | Each day, you may choose a color. Rooms of the chosen color are more likely to be drawn while drafting.                               |
| Mantle of the Knight   | Add The Armory to your Draft Pool.                                                                                                    |
| Resilience of the Rook | You may draw floorplans up to 4 times when drafting the 4 corner rooms of your house                                                  |
| Gambit of the Queen    | Each time you draft a room on the Queenside (West Wing) of your house, lose 5 Steps and gain 1 Key.                                   |

---

## 7 Room Colors

| Color  | Room Type   | General Effect                                         |
|--------|-------------|--------------------------------------------------------|
| Blue   | Blueprints  | Most common; neutral to beneficial                     |
| Purple | Bedrooms    | Extra steps; Lady Epsen, Eraja, dreams, sleep          |
| Orange | Hallways    | Keys; Connecting rooms, usually lots of doors          |
| Green  | Green Rooms | Gems; Outdoor/garden; Dig Spots; can grow flower-Gems  |
| Red    | Red Rooms   | Negative effects; Red == Fenn Aries == Lies            |
| Yellow | Shops       | Gold & Shops; Buying or exchanging items               |
| Black  | Blackprints | Ancient rooms from the 2nd era; Royalty, wealth, power |

## Items

- **Allowance Token**
  - You have been awarded an Allowance Token. Your Allowance has been permanently raised by 2 coins.
- **Apple**
  - An apple.
- **Banana**
  - A banana.
...
- **Battery Pack**
  - A large Battery Pack. Provides juice to contraptions made in the workshop.
- **Blueprint**
- **Broken Lever**
  - What appears to be a Broken Lever. Could prove to be useful.
- **Burning Glass**
  - Can light candles and ignite fuses.
- **Cabinet Key**
  - A long buried File Cabinet Key. Likely opens up a drawer somewhere on the estate.
- **Cabinet Key**
- **Cabinet Key**
- **Car Keys**
  - A spare set of Car Keys. The only car left on the estate should be in the Garage.
- **Chronograph**
  - While drafting you may Rewind time after drawing new floorplans. You are more likely to draw Tomorrow rooms while drafting.
- **Coffers**
- **Coin**
- **Coin Purse**
  - A small Coin Purse. Each time you collect 3 coins, earn 1 additional coin in interest.
- **Compass**
  - A navigational Compass. Draw floorplans leading North more frequently.
- **Coupon Book**
  - A discount Coupon Book. Save 1 coin on each purchase you make on the Estate.
- **Crown of the Blueprints**
  - The first time you draw a Red Room while drafting, you may remove it from today's Draft Pool. If you do, gain 1 Gem and redraw Floorplans.
- **Cupcake**
  - A cupcake.
- **Cursed Effigy**
  - You have foolishly picked up the deadly stone Cursed Effigy. CURSE MODE is now unlocked. (also you are cursed!) You can now select CURSE MODE when starting a new game file.
- **Detector Shovel**
  - Greater chance of finding Coins and Keys. Much greater chance of finding Coins and Keys while digging
- **Diary Key**
  - Lady Epsen's Diary Key
- **Dowsing Rod**
  - While drafting, points toward rooms that may contain more items than usual.
- **Electro Magnet**
  - You are more likely to draft Mechanical Rooms while drafting. Automatically collects Coins and Keys when entering a room.
- **Emerald Bracelet**
  - You do not have to pay the gem costs of floorplans.
- **Gear Wrench**
  - An adjustable Gear Wrench. Each time you draft a Mechanical floorplan, you may permanently adjust its rarity.
- **Gem**
- **Hall Pass**
  - A student Hall Pass. You will not lose steps traveling between two adjoining Hallways. Hallways drafted from an adjoining Hallway do not cost gems to draft.
- **Ivory Dice**
  - While drafting, you may use ivory dice to roll new floorplans.
- **Jack Hammer**
  - Vastly increased rewards from mining Dig Spots.
- **Key**
- **Key 8**
  - Presumably will unlock Room 8
- **Keycard**
  - An electronic keycard. Opens electronically-powered doors.
- **Knight's Shield**
  - Once per day while drafting you can equip the Knight's Shield to ignore the negative effect of any one Red Room.
- **Lock Pick**
  - A hobbyist Lockpick kit. Will occasionally be able to unlock some locked doors.
- **Lucky Purse**
  - Doubles the amount of Coins gained.
- **Lucky Rabbit's Foot**
  - A genuine Lucky Rabbit's Foot. Greater chance of finding items.
- **Lunch Box**
  - When you reach Rank 5 today, gain 10 Steps.
- **Magnifying Glass**
  - A wood and brass Magnifying Glass. Inspect documents of the Estate more closely.
- **Master Key**
  - Opens all doors in the estate that can be opened with regular Keys.
- **Metal Detector**
  - A functioning Metal Detector. Greater chance of finding coins and keys.
- **Microchip 1**
  - A small data Microchip buried in a old jar. Looks like it might be able to be plugged in somewhere.
- **Microchip 2**
  - A small data Microchip buried in a old jar. Looks like it might be able to be plugged in somewhere.
- **Microchip 3**
  - A small data Microchip buried in a old jar. Looks like it might be able to be plugged in somewhere.
...
- **Morning Star**
  - Can knock the locks off chests and trunks. Tomorrow, gain 1 Star.
- **Orange**
  - An orange.
- **Ornate Compass**
  - While drafting, you may rotate the first three floorplans you draw.
- **Paper Crown**
  - A paper crown.
- **Pick Sound Amplifier**
  - Has a greater chance of picking high sensitivity locks.
- **Power Hammer**
  - A stronger Sledgehammer that can also knock down weak brick walls.
- **Prism Key**
  - If you unlock a door with the Prism Key in a Green Room, Hallway, Bedroom, Red Room, or Shop, you will draw floorplans of that same color.
- **Repellent**
  - An aerosol can of Repellent. Press the indicated button in any room in your house to use. Starting tomorrow, that floorplan will be removed from the house and draft pool for one week.
- **Royal Scepter**
  - A royal scepter.
- **Running Shoes**
  - A pair of Running Shoes. Lose less steps when traveling longer distances across the estate and grounds.
- **Salt Shaker**
  - A glass Salt Shaker. Whenever you eat food and gain steps, gain an extra step.
- **Sanctum Key**
  - A Sanctum Key
- **Secret Garden Key**
...
- **Self-Igniting Torch**
  - Can light candles and ignite fuses.
- **Shovel**
  - An old weathered Shovel. Looks like it could be useful for digging.
- **Silver Key**
  - The Silver Key. Unlocking a door with the Silver Key will lead to a room with many doors.
- **Silver Spoon**
  - Whenever you gain steps from eating, gain twice as many.
- **Sledge Hammer**
  - A heavy Sledgehammer. Can shatter padlocks on locked trunks.
- **Sleeping Mask**
  - A black silk Sleep mask. The first time you enter each Bedroom with the Sleep Mask, gain 5 steps.
- **Star**
- **Steps**
- **Stopwatch**
  - For the next minute, all costs associated with Drafting Rooms are removed, and all doors are unlocked.
- **Telescope**
  - A spyglass Telescope. Gain an additional effect of each constellation observed in the Observatory.
- **The Axe**
  - You may use The Axe in the Room Directory to permanently remove the Gem cost from one Room.
- **The Key of Aries**
  - A key crafted from infused second era gold and soot-black onyx, adorned with the original insignia of the Aries family crest.
- **Treasure Map**
  - N/A
- **Upgrade Disk**
...
- **Vault Key 370**
  - A Safe Deposit Box Key.
- **Watering Can**
  - A garden ready Watering Can. The first time you enter each Green Room, use 1 Water to gain 1 gem. Limited Capacity: 3 Water
- **Wind-Up Key**
  - A rather curious Wind-up Key. A component of the Parlor Game.
...
> Left page contains a square/grid pattern image.  

### Atelier Blueprint Grid
...
> # Atelier Blueprint Grid  
>
> Source image: `/home/ubuntu/.openclaw/media/inbound/19a5c560-c7d2-4f2c-ade3-9b4594874d0c.png`  
>
> This file captures the confirmed 9×5 room-name grid, word grid, and letter grid from the Atelier blueprint image.  
>
> ## Room Names — 9×5 Grid  
>
> | Row | Col 1            | Col 2            | Col 3               | Col 4            | Col 5           |  
> |-----|------------------|------------------|---------------------|------------------|-----------------|  
> | 1   | Archives         | Chapel           | Vestibule           | Coat Check       | Aquarium        |  
> | 2   | Foyer            | The Pool         | Servant's Quarters  | Pump Room        | Furnace         |  
> | 3   | Gymnasium        | Laundry Room     | Guest Bedroom       | Conference Room  | Den             |  
> | 4   | West Wing Hall   | Passageway       | Dark Room           | Closet           | Parlor          |  
> | 5   | Billiards Room   | Trophy Room      | The Foundation      | Ballroom         | Spare Room      |  
> | 6   | Nook             | Kitchen          | Corridor            | Music Room       | Lavatory        |  
> | 7   | Solarium         | Hallway          | Dining Room         | Observatory      | East Wing Hall  |  
> | 8   | Bedroom          | Drawing Room     | Gallery             | Library          | Cloister        |  
> | 9   | Conservatory     | Maid's Chambers  | Entrance Hall       | Pantry           | Storeroom       |  
>
> ### Room Names — Flattened  
>
> Archives | Chapel | Vestibule | Coat Check | Aquarium  
> Foyer | The Pool | Servant's Quarters | Pump Room | Furnace  
> Gymnasium | Laundry Room | Guest Bedroom | Conference Room | Den  
> West Wing Hall | Passageway | Dark Room | Closet | Parlor  
> Billiards Room | Trophy Room | The Foundation | Ballroom | Spare Room  
> Nook | Kitchen | Corridor | Music Room | Lavatory  
> Solarium | Hallway | Dining Room | Observatory | East Wing Hall  
> Bedroom | Drawing Room | Gallery | Library | Cloister  
> Conservatory | Maid's Chambers | Entrance Hall | Pantry | Storeroom  
>
> ## Word Grid — 9×5 Grid  
>
> | Row | Col 1   | Col 2   | Col 3   | Col 4   | Col 5     |  
> |-----|---------|---------|---------|---------|-----------|  
> | 1   | THROUGH | LANTERN | LIGHT   | IN      | SKETCHES  |  
> | 2   | CAST    | A       | TINT    | OF      | TRUTH     |  
> | 3   | TO      | FIND    | OUR     | PATH    | A         |  
> | 4   | HUE     | OF      | WISDOM  | TO      | TURN      |  
> | 5   | US      | RIGHT   | A       | SHADE   | OF        |  
> | 6   | RAIN    | TO      | PASS    | THE     | LIGHT     |  
> | 7   | THROUGH | LANTERN | LIGHT   | IN      | SHADOWS   |  
> | 8   | PAST    | WE      | SEEK    | WHAT'S  | LEFT      |  
> | 9   | OF      | THE     | LIES    | WE      | CAST      |  
>
> ### Word Grid — Flattened  
>
...
> OF | THE | LIES | WE | CAST  
>
> ### Word Message — Flattened Sentence  
>
> THROUGH LANTERN LIGHT IN SKETCHES CAST A TINT OF TRUTH TO FIND OUR PATH A HUE OF WISDOM TO TURN US RIGHT A SHADE OF RAIN TO PASS THE LIGHT THROUGH LANTERN LIGHT IN SHADOWS PAST WE SEEK WHAT'S LEFT OF THE LIES WE CAST  
>
> ## Letter Grid — 9×5 Shape  
>
> ```text  
> THESE  
> VYING  
...
> ```  
>
> ### Letter Message — Flattened  
>
> THESE VYING PLANS FORGE BARON CREST AMONG HEWAM BLEST  
>
> ## Notes  
> - Room orientation and lantern colors between rooms are not included.  To be viewed in accompanying image(s)  
...
> Bridgette,  
> Please check if any books matching these titles are available for purchase in Redington.  
>
> FLIGHT OF THE QUEEN  
> MARCH OF THE COUNT  
> FALL OF THE LORD  
...
>
> One final counsel I leave you:  
> The waters of the west spring shall yet reveal more secrets than these mere passages.  
>
...
>
> Moreover, to the Grand Cathedral of Eraja, I bequeath eight stone statues, sculpted in the likeness of the eight Ajeran Angels: Orinda, Lydia, Rynna, Joya, Dauja, Veia, Mila, and Draxus. These sculpted figures have been in the Sinclair tomb for multiple generations, and, even though there has been much debate over their natural numeric order, they have nevertheless remained steadfast in their safeguarding of our family's secrets. I trust they will continue to provide the Cathedral of Eraja that same level of stewardship.  
>
> I give and bequeath, to my grandnephew, Simon P. Jones, son of my dear niece Mary Matthew, all the rest, residue and remainder of my estate, and of my right, title and interest in and to the house and land which I own near Mount Holly as a token of the cordial and affectionate friendship which for nearly half a century his grandmother, Clara Epsen has shown me.  
>
...
Location: Library
Wiki: <https://blue-prince.fandom.com/wiki/A_Sightseer%27s_Guide_to_Reddington>
...
>
> Spectacular scenery, a historic castle, and a charming underground bazaar reward visitors who wish to explore further. Reddington is that type of unique, enchanting place that lingers in your mind and memories along after you leave her.  
>
> The Botanical Gardens  
>
> Ilex x meserveae, a specimen of Holly unique to Reddington's mountains  
>
> The Botanical Gardens  
>
...
>
> It's only a few hours from Reddington to get to the trailhead, and you won't need any local guides or special gear if the tackle the trail during the summer season. However, those willing to give this mountain a significant amount of planning and research will be greatly rewarded, whether or not they actually summit.  
>
> On the opposite side of the peak, far from the trail, rests the Estate of Mount Holly, nestled between the summit's northern slop and saddle. This 80-acre mountain residence is almost as old as Reddington itself, however, unlike Featherfall Keep, the property has been complete private since the closing of the Mount Holly schoolhouse in '66. Still, hikers will be able to appreciate the house's unique architecture at a distance from one of the trail's many north-facing overlooks.  
>
...
Wiki: <https://blue-prince.fandom.com/wiki/Alzara_Forecasting>

Transcript:

> Transcripts of all 6 Alzara visions (fortune-telling machine in the game):  
>
> - Intro (same for first 5 visions):  
>
...
>
> - Outro (same for the first 5 visions):  
>
...
>     ...the hours to pass.  
>
> - Vision 6 (different intro/outro)  
>
...
Wiki: <https://blue-prince.fandom.com/wiki/Antechamber_Note>
...
### Atelier Note
Location: The Atelier
Wiki: <https://blue-prince.fandom.com/wiki/Atelier_Note>
...
> Lady Auravei Project completed November 1913  

### Basement Card
Wiki: <https://blue-prince.fandom.com/wiki/Basement_Card>

Transcript:

> HUNDRED BELLS  
> Sandy Heights  
> 5pm Handwriting Coincidentally, the handwriting matches Jean Ribbon's.  

### Blackbridge Grotto Admin Logs
Location: Blackbridge Grotto
Wiki: <https://blue-prince.fandom.com/wiki/Blackbridge_Grotto_Admin_Logs>
...
>
> 01-26-86 — From: MoorR  
> All remaining computer terminals on the estate are now connected to the network mainframe and we will now begin testing remote access capabilities between them.  
>
> I've also asked the Baron to come up with a name for the Network.  
>
> 01-30-86 — From: MoorR  
...
>
> 07-01-86 — From: MoorR — Subject: Regular maintenance Report  
> Fixed a connection error that was occurring between the office and security terminal. We have also added electronic mail capabilities to each terminal that can be accessed via the network.  
>
> 02-10-87 — From: MoorR  
...
>
> 03-02-87 — From: [-DELETED-]  
> -- DELETED LOG --  
>
> 03-03-87 — From: [-DELETED-]  
> -- DELETED LOG --  
>
> 03-04-87 — From: [-DELETED-]  
> -- DELETED LOG --  
>
> 03-06-87 — From: [-DELETED-]  
> -- DELETED LOG --  
>
> 03-07-87 — From: [-DELETED-]  
> -- DELETED LOG --  
>
> 03-09-87 — From: [-DELETED-]  
> -- DELETED LOG --  
>
> 03-14-87 — From: [-DELETED-]  
> -- DELETED LOG --  
>
> 07-10-87 — From: [-DELETED-]  
> -- DELETED LOG --  
>
> 07-11-87 — From: [-DELETED-]  
> -- DELETED LOG --  
>
> 07-12-87 — From: [-DELETED-]  
> -- DELETED LOG --  
>
> 07-25-87 — From: MoorR  
...
>
> 08-27-87 — From: [-DELETED-]  
> -- DELETED LOG --  
>
> 08-28-87 — From: [-DELETED-]  
> -- DELETED LOG --  
>
> 09-01-87 — From: MoorR  
...
>
> [Deleted / Full Logs recovered so far]  
>
> 02-10-87 — From: MoorR  
> Recording capabilities of all cameras on the estate have been disabled. Additionally, the existing video playback functionality on the Security Terminal has also been removed.  
>
...
>
> 03-07-87 — From: WithP  
> Be at ease, friend. It is of little consequence. Let us know when the transfer is complete.  
>
> 03-09-87 — From: MoorR  
...
>
> 08-28-87 — From: MoorR — Subject: [RibbJ] and [WithP] delisted in User Database [RibbJ] and [WithP] delisted in User Database  
>
> [Dummy Logs recovered so far]  
>
> 02-10-87 — From: LeeB  
> Three new admin keys have been added to the network's user database. [LeeB] [ProvC] and [HounU].  
>
> 02-10-87 — From: LeeB — Subject: Admin Log view access restricted to the following Admin Keys:  
...
>
> 06-26-87 — From: LeeB Resuming operations.  
>
> 06-27-87 — From: ProvC  
...
>
> 08-26-87 — From: LeeB [ProvC] and [HounU] and [LeeB] delisted and deleted from User Database.  

### Blank Book
Wiki: <https://blue-prince.fandom.com/wiki/Blank_Book>

Transcript:

> Blank Book  
> DB-only placeholder for the two Library still-water books: Tended Rose Vine and A Hidden Hue.  

### Bunk Room Journal
Wiki: <https://blue-prince.fandom.com/wiki/Bunk_Room_Journal>

Transcript:

> HSS (black): TODAY is a good day because Simon is at camp and he is not as much fun as my friends. I will not have to share my toys and I will not have to share my room and I will not have to share my snacks.  
>
...
>
> SHS (red): HERBIE IS MEAN AND REALLY STUPID AND TODAY IS A GOOD DAY BECAUSE I THREW AWAY HIS AIRPLANE.  
>
> I ALSO HAD MORE FUN AT CAMP THAN HE HAS HAD IN HIS ENTIRE LIFE.  
>
> HSS (black): TODAY is a good day because I got my brother in trouble for reading my private jounral without my permission and writing mean things in it too. He also threw my model airplane in the bushes outside but I got it back and IF HE DOES it again he will NOT get to go to the park on friday and i will make sure he gets no presents for his birthday  
>
> SHS (red): I DONT NEED ANY PRESINTS BECUSE I HAVE MY BROTHERS BOOK BECAUSE HE WONT STOP RITING ABOUT ME AND TODAY IS A GOOD DAY BECAUSE I KNOW HE CRIES WHEN HE CAN'T FIND HIS BOOK EVEN THOE HE IS OLDER. HE IS A CRYBABY  
>
> Last page (typed): In the back of the handwritten is a typed note in black: Today is a good day because today, my brother returns from college and I get to finally return to him the book I took from him a long, long time ago.  
>
...
>     I still would rather have had a sister,  
>
> Congrats on the diploma and welcome home!  
> -Simon  

### Car Note
Location: Garage
Wiki: <https://blue-prince.fandom.com/wiki/Car_Note>

Transcript:

> The drop-off address is 14227 Sandy Heights. A small garage on the south edge of Trinsdale.  
>
> The goods are already secure and in the trunk, so just unload and get back here before noon. I've seen Sinclair's schedule and I don't think he'll be requesting the car today but you never know when the cat will want some air.  
>
> Tomorrow will likely be the last delivery and I believe Denny already has payment ready.  

### Clock Tower Note
Location: Clock Tower
Wiki: <https://blue-prince.fandom.com/wiki/Clock_Tower_Note>
...
> Dearest Children,  
>
> The pieces are in place and all rigid cogs have been greased. However, if our ambitious plans are to succeed, we must strike this Tuesday. The routine changing of guard personnel on the first of each month means the opportunity we have created for ourselves will likely never be so opportune. If we wait even one additional week, the window will be closed.  
>
...
### Commissary Memo
Location: Commissary
Wiki: <https://blue-prince.fandom.com/wiki/Commissary_Memo>
...
Wiki: <https://blue-prince.fandom.com/wiki/Conference_Room_Memo>
...
Location: Conference Room
Wiki: <https://blue-prince.fandom.com/wiki/Conference_Room_Note>

Transcript:

> REMINDER  
> AFTER MEETING ADJOURNS, TAKE ALL CONFERENCE NOTES AND PLACE THEM IN THE  
> OFFICE  
> SAFE  

### Conservatory Note
Location: Conservatory
Wiki: <https://blue-prince.fandom.com/wiki/Conservatory_Note>
...
Wiki: <https://blue-prince.fandom.com/wiki/Darkroom_Hartley_Memo>
...
Location: Darkroom
Source: Unknown
Wiki: <https://blue-prince.fandom.com/wiki/Darkroom_Note>

Transcript:

> print notes  
>
> H.S. has requested yet another print of her Ladyship, I assume for one of her rooms in the West Wing, as well as an enlarged print of the enclosed photograph.  
>
> He said the last development was too dark so keep an eye on that.  

### Drafting Strategy Vol. 1
Location: Drafting Studio
Wiki: <https://blue-prince.fandom.com/wiki/Drafting_Strategy_Vol._1>
...
Location: Dormitory
Wiki: <https://blue-prince.fandom.com/wiki/Drafting_Strategy_Vol._2>

Transcript:

> Drafting Strategy Architectural Digest Vol. 2  
> VOLUME II — MARCH ISSUE  
>
> CONTENTS  
>
> MY TYPE OF ROOM  
...
> Guide to Drafting Rooms .................................... 4  
>
> SHIFTING GEARS  
> Guide to Mechanical Rooms ................................. 6  
>
> NO TIME LIKE THE FUTURE  
> Guide to Tomorrow Rooms ................................... 8  
>
> PERPLEXING PLANS  
> Guide to Puzzle Rooms ..................................... 10  
>
> SPREADING YOUR WINGS  
> Guide to Spread Rooms ..................................... 11  
>
> WORD FROM THE EDITOR  
> by the Editor ............................................. 15  
>
> MY TYPE OF ROOM  
> The Categorization of Floorplan Subtypes  
>
> As architects, we know that designing a building is a complex and multi-faceted process. From the layout to the details, every decision we make can have a significant impact on the final result. Perhaps, that's why we're always looking for ways to improve our craft and refine our ideas.  
>
> In this edition of "Drafting Strategy," we're excited to introduce a useful concept that can take your designs to the next level: Room Subtypes. While we've previously explored the use of colored floorplans to categorize the basic kinds of rooms, in this issue, we will be examining architectural symbols that can be used to further classify and differentiate the types of rooms in your house.  
>
> These symbols provide the draftsman with a visual way to indicate the purpose and function of a room. Whether it's a designated workspace, a utility control room, or a conundrium, these subtype symbols can communicate the intended use of a room at a quick glance. By including these symbols on their floorplans, architects can make it easier for contractors and builders to understand their vision and bring it to life. But the benefits of floorplan categorization go beyond just clarity. By understanding and identifying subtypes, architects can craft strategies that surpass the surface-level simplistic approaches commonly used by inexperienced drafters.  
>
> THE CRAFT OF THE DRAFT  
> Architectural Digest's Guide to Drafting Rooms  
>
> Drafting Rooms are floorplans that affect the draft pool or the drafting process. As such, they are spaces that are often designed for activities related to academic pursuits and research. Some of their common features include floorplan redrawing, draft pool manipulation and rarity adjustments. As students of the art of drafting, aspiring architects can greatly benefit from the knowledge, experience and learning opportunities that these rooms offer.  
>
> LIBRARY  
...
>
> CLASSROOM  
> While drafting in CLASSROOM, you may draw new Floorplans one time for each room in your house.  
>
> Academia isn't only found in the mountains of Corarica. CLASSROOM is a great example of the scholastic strategies that this room type has to offer. Not only does it provide synergy for other Drafting Rooms, but it's also a valuable source of information and knowledge.  
>
> DID YOU KNOW?  
> The classrooms you'll find will fall under one of eight different grades, ranging from first grade to the culmination of your academic journey, Grade 8. However, there are rumors of an additional annex classroom at Mount Holly Elementary, used solely for exams and student testing, but finding it has been near impossible as it requires drafting more than eight classrooms.  
>
> SHIFTING GEARS  
> Architectural Digest's Guide to Mechanical Rooms  
>
> Far from the pristine white pages of academia, the mechanical world is a rugged industrial space, marked by the symbol of the gear and stained with the grime of heavy machinery. These floorplans prioritize function over aesthetics, and the design of each mechanical room reflects this focus on efficiency. These rooms serve as the command centers for estate operations, housing the control systems that keep everything running smoothly.  
>
> UTILITY CLOSET  
> Breaker Box  
>
...
> Power Source  
>
> BOILER ROOM is known as a POWER SOURCE because it provides steam power to various rooms in the house. Steam is conveyed room-to-room via ducts that run across the ceiling, and power can be transported across great distances as long as you continue to string together rooms that contain power ducts. So when you're in a room, look up. There might be a duct!  
>
> DID YOU KNOW? DRAFTING FROM A DOOR THAT IS STEAM-POWERED WILL INCREASE THE LIKELIHOOD OF DRAWING ROOMS WITH DUCTS!  
>
> NO TIME LIKE THE FUTURE  
> Architectural Digest's Guide to Tomorrow Rooms  
>
> Some rooms offer long-term benefits rather than immediate resources. These floorplans, known as TOMORROW ROOMS, are considered an investment for the future, and they offer the forward-thinking architect a number of strategies that will pay dividends down the road. Strategic planning is critical to drafting success, and knowing when to forsake the current day's progress to set yourself up for a prosperous future is a critical decision that each architect will encounter.  
>
> SAUNA  
> Tomorrow, you will start the day with 20 extra steps.  
>
> COAT CHECK  
> Check one item and retrieve it on another day.  
>
> TIME FREEZE  
> Nothing better exemplifies setting yourself up for tomorrow at the expense of today than FREEZER. But drafters who may not want to totally abandon their current day's progress will be pleased to know there are a few clever ways to manipulate FROZEN ASSETS.  
>
> FREEZER  
> Freezes your accounts.  
> Gems and gold amounts will not reset at the end of the day and they cannot be adjusted or used until tomorrow.  
>
> FURNACE  
> You are more likely to draw Hot Rooms while drafting.  
>
> Entering FURNACE or SAUNA, after drafting FREEZER, will thaw any frozen gems or gold you are carrying and you will once again be able to use them. However, if you still wish your accounts to carry over to the next day, you will have to refreeze your assets again by re-entering FREEZER.  
>
> WARNING!!  
> If FURNACE is drafted within a few ranks of FREEZER then the temperature will start rising and everything will melt, including your assets. If the temperature gets too high, refreezing will no longer be possible.  
>
> PERPLEXING PLANS  
> Architectural Digest's Guide to Puzzle Rooms  
>
> Any architect who loves a challenge inevitably ends up drafting a few Puzzle Rooms in their house. These floorplans, marked only with a single enigmatic jigsaw piece, lack accompanying text and explanations, as if to suggest that even understanding the room's function is part of the puzzle. Some Puzzle Rooms, like PARLOR and BILLIARD ROOM, become increasingly difficult as you solve them, evolving over time as you progress.  
>
> PARLOR  
>
> BILLIARD ROOM  
>
> SPREADING YOUR WINGS  
> Architectural Digest's Guide to Spread Rooms  
>
> The final type of room we will cover in this issue is the SPREAD ROOM. These floorplans enable the architect to spread out items among many rooms. When items are spread, they are only placed in currently active rooms in the house. The number of items that are spread is determined by the number of rooms on your estate. Waiting until your house is bigger will provide larger spreads. Strategies that employ Spread Rooms are often centered around travel and backtracking.  
>
> LOCKER ROOM  
> Spread throughout the house.  
>
> PATIO  
> Spread in each Green Room.  
>
> WORD FROM THE EDITOR  
>
> I wanted to use this segment to thank all our readers for the wonderful mail and feedback we've received after we sent out our very first issue of Drafting Strategy. It's incredibly rewarding to create something that is appreciated. It's even more rewarding to know that somewhere out there, a young architect is reading our magazine and getting inspired to build something of his own that may one day, in turn, inspire others.  
>
> When I was a child, I vividly remember the experience of reading the memoirs of the court's Grand Architect, Louza T. Reyland. To say it changed me is an understatement. It had a profound effect on the way I view the world and the spaces within it. We each draft our own dreams as a child—faint sketches on blurry blueprints, illegible to all, especially ourselves. And our purpose?  
>
> Why, it is found hidden in the floorplans of our youth.  

### Drafting Strategy Vol. 3
Location: Library
Wiki: <https://blue-prince.fandom.com/wiki/Drafting_Strategy_Vol._3>

Transcript:

> Drafting Strategy Architectural Digest Vol. 3  
> VOLUME III — JUNE ISSUE  
>
> CONTENTS  
>
...
>
> To the ambitious young architect, a fresh blueprint represents a world of boundless possibilities. When you are staring at a blank canvas, you have unlimited potential and ideas to explore. But, with an abundance of options at your disposal, the architect can also become overwhelmed by the countless choices and decisions that need to be made: Should I draft a Hallway or a Closet? How many bedrooms do I need in my house? Is Passageway really worth two gems?  
>
...
>
> HAVE GEMS WHILE DRAFTING  
>
> One of the most common ways architects draft themselves into a corner is by not having the resources they need when opening a new door. If you lack the GEMS to consider all three presented options, you may be forced to draft a room you do not want. To avoid this predicament, focus on drafting rooms that grant you GEMS and prioritize acquiring GEMS as early in the day as you can. This approach is a sure-fire way to set yourself up for success.  
>
> READER SUBMITTED GEM STRATS  
>
...
> —Matthew M.  
>
> Think about saving some gems for emergencies. I try to only spend them if I really, really need a room!  
> —Jenn H.  
>
...
>
> DRAFT EARLY RANKS FIRST  
>
> A very common mistake beginners make is drafting in a straight line north, and ignoring the many unopened doors they have left behind in the Entrance Hall and rooms of the early ranks. When these architects reach the higher ranks, they quickly discover they do not have enough keys or gems to continue. Their day usually ends by returning to the lower ranks to draft from the doors they skipped, only to find rooms and items that would have made all the difference if they had only been found earlier in the day.  
>
...
>
> Another aspect to consider when planning your house is the order in which you draft rooms. For instance, if you draft CLOISTER before TERRACE, you will be down 3 gems. But, if you draft them in the reverse order, CLOISTER would be free! Identifying a synergistic pair of floorplans is an essential first step. But, determining the optimal order for drafting those rooms will provide you with an additional advantage, significantly improving your chances of success.  
>
> TERRACE  
> Green Rooms do not cost to draft.  
>
> CLOISTER  
> GEM COST: ◇ ◇ ◇  
>
...
>
> A FOYER drafted before GREAT HALL would mean that all of its many doors would be unlocked.  
>
> GREAT HALL  
> 7 Locked Doors  
>
> NURSERY  
> (Whenever you draft a Bedroom, gain 5!)  
>
> Drafting BUNK ROOM after NURSERY will give you 10 extra steps because it counts as two separate bedroom triggers.  
>
> BUNK ROOM  
...
>
> You won't have to backtrack constantly to collect your gold spread from OFFICE, if you draft a CONFERENCE ROOM.  
>
> CONFERENCE ROOM  
...
> Estate Connectivity  
>
> Two-pair combos aren't the only form of room synergy. You will find some floorplans only work by drafting other specific rooms! These rooms aren't powerful on their own, but can become very useful when their connectivity is eventually discovered. The UTILITY CLOSET is a perfect example of this! It doesn't do anything by itself but it can literally power up (or down) other rooms you have drafted in your house.  
>
> UTILITY CLOSET  
> Breaker Box  
>
> - GARAGE - powers garage door and grants west path access  
...
> The next time you enter: BOUDOIR, gain 10  
> The next time you enter: WALK-IN CLOSET, gain 3  
>
> One of the more simple examples, HER LADYSHIP'S CHAMBER, has synergy with Lady Epsen's other two rooms, her BOUDOIR and her WALK-IN CLOSET.  
>
> BOILER ROOM  
> Power Source  
>
> The BOILER ROOM connects ducts from room to room to run steam-power to specific destinations in the house. LABORATORY, GARAGE, LAUNDRY ROOM, FURNACE and PUMP ROOM all have uses for steam-power.  
>
> PUMP ROOM  
> Control water flow throughout the Estate  
>
> Speaking of PUMP ROOM, this room controls the water level throughout rooms in the estate and can interact directly with THE POOL, AQUARIUM, GREENHOUSE, KITCHEN, and several other features located outside of the main house.  
>
> TIPS & TRICKS  
>
> - In the KITCHEN, you can check which course is being served in the DINING ROOM that day. This will allow you the opportunity to draft specific rooms that will make the meal even more delicious!  
>
> - Besides counting as two bedrooms, BUNK ROOM also counts as two rooms! This will increase the amount of steps granted by MASTER BEDROOM, the amount of gold spread by the TOMB and the amount of keys found in a SERVANT'S QUARTERS.  
>
> - Each time you solve a puzzle in BILLIARD ROOM or PARLOR, the difficulty will increase slightly the next time you draft that room.  
>
> - Just because you didn't find any items in a room when you first explored it, doesn't mean that will be the case the next time you draft it.  
>
...
>
> - If you are stuck or don't know what to do in a specific room, sometimes it is smart to move on. There are multiple ways to solve many of the challenges you will come across, and there is a very good chance you will find a piece of information down the road which may help.  
>
> - When in doubt:  
>
> DRAFT ROOMS YOU HAVE NEVER SEEN BEFORE  
>
> Even if you do not think the rooms seem very useful, they may still hold useful clues and information that may help you on your journey.  
>
> WORD FROM THE EDITOR  
>
> Although with this volume we have provided our readers with many potential strategies and tricks to try, we here at ARCHITECTURAL DIGEST hope that aspiring architects know that there truly is no set blueprint for success.  
>
...
Location: Bookshop
Wiki: <https://blue-prince.fandom.com/wiki/Drafting_Strategy_Vol._4>

Transcript:

> Drafting Strategy Architectural Digest Vol. 4  
> VOLUME IV — AUGUST ISSUE  
>
> CONTENTS  
>
> TOOLS OF THE TRADE  
...
> Drafting Items ............................... 4  
>
> GLUE, GREASE AND GUTS  
> Workshop Contraptions ........................ 6  
>
> IT'S ABOUT TIME FOR AN UPGRADE  
> Guide to Upgrade Disks ....................... 8  
>
> TOOL TIPS  
> Tricks for Itemized Success ................. 10  
>
> WORD FROM THE EDITOR  
> by the Editor ............................... 15  
>
> TOOLS OF THE TRADE  
> Taking Issue with Inventory.  
>
> In the world of drafting, the tools an architect wields are crucial in shaping their vision and bringing their designs to life. The precision, elegance, and functionality of these instruments can have a profound effect on the drafting process and the final outcome of your project. That's why it's very important to choose the right tools to complement your drafting techniques.  
>
> In this issue of "DRAFTING STRATEGY", we will dive into the vast realm of INVENTORY, bringing to light the many hidden tools of the trade that can enhance your favorite strategies and elevate your architectural ambitions to unprecedented heights.  
>
> From classic compasses and T-squares to state-of-the-art software upgrades, the variety of drafting tools available to architects today is staggering.  
>
> As we navigate this diverse landscape, regardless of whether you are a seasoned professional seeking to refine your toolkit or a budding draftsman searching for a basic set of instruments, the following articles will provide invaluable insights and guidance for architects of all levels.  
>
> THE GUIDING COMPASS  
> An Introduction to Drafting Items  
>
> GEMS  
> You can't have a conversation about drafting items without starting with GEMS. These valuable stones allow architects to draft special floorplans.  
>
> STOPWATCH  
> A more short-term (very short-term) alternative to paying gem costs is utilizing a STOPWATCH to bypass any gem costs you encounter during a frantic one-minute drafting dash.  
>
> EMERALD BRACELET  
> Of course, if you are wealthy enough to be able to afford to purchase it from the SHOWROOM, this very high-end luxury item removes the gem cost of special floorplans altogether.  
>
> REPELLENT SPRAY  
> But why remove gem costs when you can just remove the whole room? REPELLENT SPRAY can free you of that annoying floorplan for up to a week!  
>
> IVORY DICE  
> DICE are a resource that allow you to REROLL for new floorplans while drafting.  
>
> BRASS COMPASS  
> A useful drafting tool that adjusts the orientation of floorplans. If a room has another exit, it will have a high chance to lead north.  
>
> SILVER KEY  
> The orientation of floorplans matters a lot less when rooms have tons of doors! SILVER KEY all but guarantees that your draft will result in a room with enough doors to ensure they lead where you want them to go.  
>
> GEAR WRENCH  
> The first item that can adjust the RARITY of floorplans in the draft pool. Although it only works on MECHANICAL ROOMS, it's a useful tool for customizing your experience.  
>
> ORNATE COMPASS  
> Another luxury item from the SHOWROOM, and likely the most useful drafting tool on this list. ORNATE COMPASS allows you to ROTATE FLOORPLANS as you draft them, allowing you to position doors to your advantage.  
>
> GLUE, GREASE AND GUTS  
> Workshop Contraptions  
>
> Crafted from the depths of resourcefulness and innovation, CONTRAPTIONS are makeshift creations born from the fusion of two or more distinct tools. Through soldering, taping, and a liberal amount of hot glue, inventors can use the workbench found in the WORKSHOP to bring together disparate elements to forge something far greater than the sum of its parts.  
>
> Blind experimentation is often the most rewarding avenue for true innovators, but for those crafters who need a bit of inspiration or guidance, we have included a list of common contraption components to kick-start your creative journey.  
>
> WORKSHOP  
> Combine inventory to create new items  
>
...
>
> IT'S ABOUT TIME FOR AN UPGRADE  
> Architectural Digest's Guide to Upgrade Disks  
>
> Perhaps the most exciting item an architect can come across is an UPGRADE DISK. This floppy data disk houses a wellspring of unique architectural plans designed explicitly for a specific room. By inserting the disk into a computer terminal, architects gain the ability to shape the destiny of a room, guided by the enticing designs contained on the disk. This myriad of options not only allows architects to craft floorplans that align with their preferred strategies but also enables them to adapt their creations to evolving project requirements. Furthermore, the UPGRADE DISK's array of plans ensures that no two architects will follow the same path, fostering a landscape of diverse architectural designs.  
>
> A FEW EXAMPLES OF ROOM UPGRADES  
>
> 16 TOTAL DISKS HAVE BEEN ISSUED  
>
> TOOL TIPS  
> Tricks for Itemized Success  
>
> HALLPASS  
>
> Stringing together adjoining HALLWAYS has always been the most straightforward strategy when using a HALL PASS. Drafting floorplans like TUNNEL and SECRET PASSAGE are an easy way to set up longer chains of HALLWAYS.  
>
> You can adjust the settings in the terminal located in SECURITY to make Security doors more or less common. If you have found a KEYCARD, it is worth changing these settings to high, and if you haven't you may want to set them to low.  
>
> For the endeavoring gardener, a WATERING CAN is a fundamental tool. But did you know, you can refill this item with water? All you need to do is find a faucet with running water.  
>
> Most GREEN ROOMS can only be drafted along the edges of your house and the SECRET GARDEN is no exception. You can use this key on any locked door leading to one of these room positions.  
>
> If you have come across any fancy ruby socketed candlesticks, you may want to take note in case you can find an item that can produce a flame. These specific candlesticks contain mechanical triggers that are tripped when the candle is lit.  
>
> WORD FROM THE EDITOR  
>
> Tools are cool. But they are only as good as the architect who harnesses their capabilities. As you finish reading this issue of "DRAFTING STRATEGY," I want you to open up your menu and look at your inventory. Take a moment to look at each item, and contemplate the true potential they all hold. The same potential you see there is the same potential that resides within yourself. For it is not the tools themselves that will sculpt the grand structures and monuments of tomorrow, but the deft hands and brilliant minds of architects like you.  

### Drafting Strategy Vol. 5
Location: Bookshop
Wiki: <https://blue-prince.fandom.com/wiki/Drafting_Strategy_Vol._5>
...
>
> *a ideal spot to draft a dead end  
>
> GRAVE MISTAKES  
>
...
>
> TOMB isn’t the only dead end you'll find on the grounds. There are a total of eight OUTER ROOMS, which are rooms that are draftable outside of the house. These floorplans are unique, not only in where they can be drafted but also in the fact that they are floorplans that cannot lead to the expansion of further rooms, making them the perfect candidate for dead ends. They are also able to be drafted at the very beginning of the day which allows architects to plan out their strategy with greater precision and purpose.  
>
...
> After you draft a red room, if you have at least 5 different ranks containing red rooms, gain 6 gems.  
>
> BLESSING of the MONK  
> If you call it a day in a room on your estate, you will draw that room while drafting from the grounds the following day.  
>
...
>
> SECRET. Surprisingly, this room is actually categorized as a DEAD END, allowing architects to utilize it in both dead-end and color specific strategies.  
>
> DEAD END CONTEST  
>
...
### Entrance Hall Letter
Location: Entrance Hall
Wiki: <https://blue-prince.fandom.com/wiki/Entrance_Hall_Letter>
...
### Entrance Hall Note
Location: Entrance Hall
Wiki: <https://blue-prince.fandom.com/wiki/Entrance_Hall_Note>

Transcript:

> SEARCHING THE ESTATE CAN BE  
> EXHAUSTING  
> Each time you enter a room you will lose 1 Step.  
> When you no longer have any Steps left, you will be too tired to continue searching the manor and must call it a day.  

### EPCW Pump System User Manual
Location: Library
Wiki: <https://blue-prince.fandom.com/wiki/EPCW_Pump_System_User_Manual>
**Borrowers**

| Date       | Borrower       |
| ---------- | -------------- |
| 1987-03-18 | Jean Ribbon    |
| 1987-03-26 | Paul Withers   |
| 1993-11-26 | Simon P. Jones |
...
> POOL SERIES 8  
>
> The EPCW PUMP SYSTEM is engineered specifically for the luxury requirements of today’s indoor in-ground swimming pool and spa. The EPCW system is also expandable allowing you to use multiple pumps to control the water flow and volume to several different designated tanks and aquatic house features, be it an aquarium, fountain or good old-fashioned swimming pool.  
>
...
>
> The functon is simple: Press a button to select the water source you would like to adjust. For example, if you wish to drain (or fill) your pool, simply press the button labeled “POOL”.  
>
...
>
> After you have selected a source using the WATER CONTROL PANEL, the next step is to set the pump associated with that source to pump either in or out. This will initiate water flow to/from one of your supply tanks.  
>
> TO TANK  
>
> PUMP LEVER  
> controls water flow direction  
>
> TO SELECTED SOURCE  
>
> THE PUMP  
...
> QUICK START GUIDE  
>
> 1. USE WATER CONTROL PANEL  
>    TO SELECT WATER SOURCE  
>
> 2. USE PUMP LEVER TO SET  
...
> Master Simon,  
>
> Good morning. It has come to my attention that you have been granted a daily allowance to use while on the estate. If it is convenient for you, I will leave the required sum here in the Entrance Hall each morning.  
>
> If there is anything else you require, please do not hesitate to ask. Even though we have all been requested to remove ourselves from the premises during your stay, I can assure you I am still personally overseeing that the estate is at least operating at a baseline standard of service that I hope you will one day come to expect of us.  
>
> Anne Babbage House Manager  

### Foreman's Logs
Location: Precipice
Source: Scripps & Rudford Mining Company
Wiki: <https://blue-prince.fandom.com/wiki/Foreman%27s_Logs>

Transcript:

> ASSAY 502  
>
> SCRIPPS & RUDFORD MINING COMPANY EXCAVATION DEPARTMENT  
>
> FOREMAN’S LOG: 3                          DATE: 7.2.1915  
>
> As our client Tomas Sinclair suspected, the arches that were visible from the south cliff were part of a much longer arcade carved into the rockface. Last week, when our crew first arrived, only two supporting pillars were visible, but after only a few days of clearing vines, moss and dirt, we have uncovered a dozen more.  
>
...
> SCRIPPS & RUDFORD MINING COMPANY EXCAVATION DEPARTMENT  
>
> FOREMAN’S LOG: 20                         DATE: 7.25.1915  
>
...
> ASSAY 502  
>
> [illegible] EXCAVATION DEPARTMENT  
>
> FOREMAN’S LOG: 220                        DATE: 3.1.1917  
>
...
> ASSAY 502  
>
> [illegible] MINING COMPANY EXCAVATION DEPARTMENT  
>
> FOREMAN’S LOG: 209                        DATE: 5.15.1917  
>
...
> SCRIPPS & RUDFORD MINING COMPANY EXCAVATION DEPARTMENT  
>
> FOREMAN’S LOG: 621                        DATE: 6.18.1918  
>
...
Location: Freezer
Source: Herbert S. Sinclair
Wiki: <https://blue-prince.fandom.com/wiki/Freezer_Letter>
...
>
> I have placed eight red envelopes in eight even more secure locations throughout the estate and left a hidden message for you among the art that hangs in almost every room in this house. This message is the key to unlocking these secrets, but you must be open in your interpretation, as the message itself harbors multiple double meanings and hidden enclaves.  
>
> One final word of guidance: the safe combinations you are seeking will not be found in writing on the estate. So, I hope you haven’t been wasting too much time jotting down random invoice numbers and dates! Only by deciphering the many meanings of the forty-four character message, can you hope to unlock its many mysteries.  
>
...
> One page is a purely visual cipher/blanks layout with no additional readable prose.  

### Freezer Note
Wiki: <https://blue-prince.fandom.com/wiki/Freezer_Note>

Transcript:

> Transcription and Letter  
> The network servers are finally out of cold storage! Or at least as many as we could fit into the surrounding walls of the Grotto off of the East Drive. The last few days have been very busy, but I'm glad I was able to take a short break from gardening to help Randolph install the network. It was, after all, the least he could do, since it was I who suggested the final location. We decided that we are going to store the two unused servers here in Mount Holly's freezer. They should serve as readily accessible replacements should any of the primary consoles fail.  
> -  
> Denny Revane (Handwritten beneath at an angle is ADMIN KEY - RevaD.)  
> Denny's note in the Freezer. Shows a bit of his unusual handwriting.  

### Fusebox Note
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Fusebox_Note>

Transcript:

> UTILITY ROOM FUSEBOX  
> (obscured) indicator settings press any button above to activate blue press a blue indicator next to a red indicator to activate purple five purple indicators are needed to activate the sixth.  
> DCPOWER inc.  
> On the note is another note reading:  
> MORE DETAILED INSTRUCTIONS WILL BE SENT BY ELECTRONIC MAIL TO THE ADDRESS CLIENT HAS PROVIDED  

### Garage Note
Location: Garage
Wiki: <https://blue-prince.fandom.com/wiki/Garage_Note>
...
Source: Robert Nogula
Wiki: <https://blue-prince.fandom.com/wiki/Gardener%27s_Logbook>
...
>
> In addition to maintaining the grounds, there are eight green rooms within the house that require some level of upkeep and light groundskeeping. The majority of these I discovered are only [illegible] on the perimeter of the house along the East and West Wings. The Terrace, Patio, Veranda, Morning Room, Greenhouse, and Secret Garden all fall within this category.  
>
> THE SOIL SURVEY  
>
...
> RICH SOIL  
>
> [Diagram: gridded soil survey chart showing barren, poor, good, and rich plots.]  
>
> SMUDGE POTS  
>
...
> Soil_survey.png.png: separate artifact image of the soil survey chart/legend; no substantial new prose beyond the SURVEY RESULTS labels.  

### Gemstone Cavern Note
Wiki: <https://blue-prince.fandom.com/wiki/Gemstone_Cavern_Note>
...
### Guest Bedroom Letter
Location: Parlor
Wiki: <https://blue-prince.fandom.com/wiki/Guest_Bedroom_Letter>
...
>
> I also got to appreciate your new game in the billiard room.  
> (It's been ages since I've seen the billiard room in the house, I was beginning to suspect you retired the floorplan.)  
> It was well worth the wait though, as I always enjoy your mathematical puzzles and appreciated that I didn't need to know the rules of darts to play your variation.  
>
...
### Hallway Memo
Location: Hallway
Wiki: <https://blue-prince.fandom.com/wiki/Hallway_Memo>
...
Wiki: <https://blue-prince.fandom.com/wiki/Her_Ladyship%27s_Diary>
...
> My dear diary,  
>
> To begin, I thought it best to start with my own room despite already knowing how unsuitable it has been for my sleep of late. Perhaps it is all the old memories that linger here, as it is impossible not to think of home among so many moments of my youth. Nonetheless, I find comfort in gazing at the stars before dozing off, and it pains me to consider that if this trial is successful, it may be one of the final occasions that I sleep here.  
>
> Clara  
>
> My Room  
...
> Guest Bedroom  
>
> Sleep Duration - Four hours Quality - Very fragmented  
>
...
> Servant's Quarters  
>
> Sleep Duration - perhaps one hour Quality - Terrible  
>
> Effects - About half the steps the following day. I also discovered a stray die had found its way into my pocket! Which was hardly shocking, given Hartley’s history.  
>
> 1 - 25 - 79  
> My dear diary,  
>
> I have to confess that I was initially hesitant to spend the night in the Baron’s room. It’s extravagantly showy, with every surface adorned with gold and every piece of furniture so large it seems almost comical. But as I lay down on the enormous bed, I was surprised to find that I felt entirely at ease. Even the absurdly oversized pillows were somehow comfortable, propping me up just right so that I didn’t feel any strain on my neck or back. I slept more soundly than I have in weeks, and I woke up feeling genuinely rested for the first time in what feels like forever.  
>
> Clara  
>
> Master Bedroom  
...
>
> Final page - A hand-drawn diagram of the west path with a four-door room drafted in the outer room, most likely the Antechamber.  

### Locker Room Green Memo
Location: Locker Room
Source: Unknown
Wiki: <https://blue-prince.fandom.com/wiki/Hovel_Note>
...
> IS A PSEUDONYM.  
>
> (This is a green memo, proven false by the adjacent Blue Tents memo: "The memo next to this is a lie". Speculation: Farro is a pseudonym for Kirk Darren.)  

### Inheritance Letter
Location: Entrance Hall
Wiki: <https://blue-prince.fandom.com/wiki/Inheritance_Letter>
...
>
> And as I grew older that lack of convinction and aimlessness amplified. I never really had any goals or objectives to strive toward. I never had any dreams to realize. I never set my sights on something beyond the horizon.  
>
...
### Laboratory Memo
Location: Laboratory
Wiki: <https://blue-prince.fandom.com/wiki/Laboratory_Memo>
...
> SECURITY  
> TERMINAL  
> (If you change the E-mail settings to only have it on in the Security room, this Red Memo will turn into a Blue Memo.)  

### Laboratory Note
Location: Laboratory
Wiki: <https://blue-prince.fandom.com/wiki/Laboratory_Note>
...
### Letters
Wiki: <https://blue-prince.fandom.com/wiki/Letters>
...
Location: Locker Room
Source: Unknown
Wiki: <https://blue-prince.fandom.com/wiki/Locker_Room_Memo>
...
> WHERE IS ROOM 46???  
>
> 7/5/90 - tested my full house theory. No luck.  
> as expected  

### Locker Room Note
Location: Locker Room
Source: Unknown
Wiki: <https://blue-prince.fandom.com/wiki/Locker_Room_Note>
...
> - Full House of 45 Rooms  
> - Secret door in Tomb    LEANING TOWARD THIS  
> - Doesn't exist (Red Herring)  
>
> GROTTO!!!  

### Maid's Chamber Note
Location: Maid's Chamber
Wiki: <https://blue-prince.fandom.com/wiki/Maid%27s_Chamber_Note>

Transcript:

> STAFF NOTICE  
> The day we all dreaded has finally arrived. It is with unprecedented sadness that we inform you of the death of our benefactor, employer and master, the Baron of Mount Holly,  
> H. S. Sinclair. Any staff who have an interest in attending services may contact Mrs. Babbage for details.  
...
### Mailroom Letter 0
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Mail_Room_Letter>
...
> The house really is amazing. I know it's been almost seven years since we were last up there, and I'm really curious to hear just how much you remember from the summer trips.  
...
> Later Alligator,  
> Dad p.s. get some sleep each night and don't spend all your time each day playing Dirigiblocks!  
> 1/4  

### Mailroom Letters
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Mail_Room_Letters>

Transcript:

> Mailroom Letters  
> A collection of letters that can be delivered to the Mail Room via the Laboratory experiment “a letter will be delivered to the Mail Room.” Successful deliveries add Mailroom Letter 1 through Mailroom Letter 16. Mailroom Letter 0 is the letter from Dad already present in the Mail Room.  
...
### Mail Room Note
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Mail_Room_Note>
...
Source: Unknown
Wiki: <https://blue-prince.fandom.com/wiki/Master_Bedroom_Note>

Transcript:

> HERB -  
>
> THE CONTROLS FOR THE FOUNDATION  
> ELEVATOR ARE LOCATED BEHIND THE  
> FOUNDATION WALL.  
>
> FOUNDATION  
>
...
> ACCESSED BY ANOTHER ROOM ADJACENT TO  
> THE FOUNDATION.  
>
...
### Memos
Wiki: <https://blue-prince.fandom.com/wiki/Memos>
...
### Messages
Wiki: <https://blue-prince.fandom.com/wiki/Messages>
...
> Mount Holly Records Mount Holly Records  
> The records book tracks player numerical statistics such as average day length and rooms drafted and can be found on the second floor of the Library.  
> For details on which rooms were drafted most in particular and other interesting player stats, see the scrapbook that is on the other side of the room.  
> Contents  
> 1  
> Contents  
> 1.1  
...
### Newspapers
Location: Marion Marigold, the pen name of
Wiki: <https://blue-prince.fandom.com/wiki/Newspapers>
...
### Notes
Wiki: <https://blue-prince.fandom.com/wiki/Notes>
...
Location: Hovel
Source: Anne Babbage
Wiki: <https://blue-prince.fandom.com/wiki/Notice_of_Termination>
...
Wiki: <https://blue-prince.fandom.com/wiki/Numeric_Core>

Transcript:

> TO THE BARONESS OF MOUNT HOLLY  
> FOR HER OWN HAND  
>
> THE NUMBERS THAT BUILT THE WORLD OF YESTERDAY (36/37) NUMERIC CORES  
>
...
> (ex. 86455 becomes 8 6 45 5)  
>
> • Next, assign each a different color, resulting in a valid mathematical equation that produces the smallest whole number possible. The first number should always be assigned teal to begin with a positive number.  
> (ex. + 8 - 6 x 45 ÷ 5)  
>
> • If the result is a number with more than three digits, repeat the above process. The final number you obtain that is less than four digits is considered the "numeric core" of the larger number.  
> (ex. 18)  
>
...
### Office Desk Drawer Note
Location: Office
Wiki: <https://blue-prince.fandom.com/wiki/Office_Desk_Drawer_Note>
...
### Office Note
Location: Office
Wiki: <https://blue-prince.fandom.com/wiki/Office_Note>
...
> bridgeTTE,  
> PLEASE PICK UP SOME MORE FRUIT BEFORE FRIDAY AS WE HAVE JUST BEEN INFORMED THAT WE MAY HAVE AN EXTRA GUEST EXPLORING THE HOUSE NEXT WEEK. FIFTY  
> Steps  
...
### Parlor Letter
Location: Parlor
Wiki: <https://blue-prince.fandom.com/wiki/Parlor_Letter>
...
Location: Parlor
Source: Unknown
Wiki: <https://blue-prince.fandom.com/wiki/Parlor_Note>
...
### Payroll Staff Notice
Location: Security, Commissary
Wiki: <https://blue-prince.fandom.com/wiki/Payroll_Staff_Notice>
...
### Mailroom Letter 10
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Randolph%27s_Letter_10>

Transcript:

> Greetings Simon, Hope all is going well on the estate, I was discussing my communications with you with another fellow technician,  
> Kimberly Thompson, and she suggested I disclose to you the locations of the Drafting Strategy issues she's personally found on the estate.  
>
> Issue I:  
> Dormitory Issue II:  
> Drafting Studio Issue III:  
> Library Issue IV:  
> Bookshop Issue V:  
> Bookshop  
>
...
### Mailroom Letter 11
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Randolph%27s_Letter_11>
...
>
> - Mrs. Anne Babbage - House Manager  
> - My Boss Kirk Darren - Head of Security  
...
### Mailroom Letter 12
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Randolph%27s_Letter_12>

Transcript:

> Another successful experiment, another letter.  
>
> You have certainly been keeping yourself busy! As I've spent the last few days racking my brain trying to come up with new clues for you, I'm reminded of your mother's aptly named book,  
> "  
> A New Clue  
> "  
> and how fiendishly she hid the clues for her readers within its pages. Don't worry, I won't be hiding my clues for you in imagery or requiring you to comb the text with a magnifying glass! The truth is I'm not nearly as clever or creative as she was. The best I could muster trying to be cryptic and mysterious would be something like "  
> Break the bricks in the Weight Room with something that has a handle and is very heavy.  
> " I am afraid that in spite of my best efforts the result is not quite cryptic and even less mysterious.  
>
...
### Mailroom Letter 13
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Randolph%27s_Letter_13>
...
> SAFE CODE: 1213  
>
> (Red Memo, Handwritten, same handwriting as Bunk Room journal)  
> SAFE CODE: D8  
>
> (Green Memo)  
...
### Mailroom Letter 14
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Randolph%27s_Letter_14>

Transcript:

> Simon,  
>
> I can't think of any reason you'd need to access the Server Administrator controls before I return, but your father has mentioned your interest in computers so I have a feeling you may be a bit more hands-on than your great uncle.  
>
...
### Mailroom Letter 15
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Randolph%27s_Letter_15>
...
>
> Normally, all three microchips are kept secured in three other locations, but I decided to make it easy for you and left one of the microchips in the grotto for ready access. However, you will have to find a new clue or two to find the others.  
>
> -  
> Randolph  
...
### Mailroom Letter 16
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Randolph%27s_Letter_16>
...
### Mailroom Letter 2
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Randolph%27s_Letter_2>
...
> SWANSONG  
>
> Happy hunting, Randolph  

### Mailroom Letter 3
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Randolph%27s_Letter_3>
...
> Simon,  
>
> Not sure if you paid too much attention to the machine in the booth of the lab, but I figured I could save you some frustration if you've been fooling with it. This contraption is the central control for power lines that run externally from the house. In the past we've served as an emergency power source for the local community as we have modest hydroelectric capabilities with a steam turbine.  
>
> If you want to use it, you'll need to first turn on the turbine in the boiler room and utilize our steam ducts to connect the turbine to the lab. This isn't required of course, and I can't think of any reason in which you'd have to use the boiler to reach ROOM 46, but feel free to play around with it should you feel inclined to experiment.  
>
> - Randolph  

### Mailroom Letter 4
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Randolph%27s_Letter_4>

Transcript:

> Simon,  
>
> In case it's useful to ya, here's a rough diagram of the STEAM DUCT SYSTEM. Due to the everchanging nature of the rooms on the estate, we ended up building the duct system to be quite flexible and if you look along the ceiling in many rooms you will find many of them have been outfitted with steam ducts. As long as you align these rooms together in an uninterrupted string, power can be transferred from room to room, even if the Boiler Room and its intended destination are on opposite sides of the house.  
>
> Lab,  
> Garage,  
> Boiler Room,  
...
### Mailroom Letter 5
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Randolph%27s_Letter_5>

Transcript:

> Simon,  
>
> Let me know if I'm writing to you too much, I've never been too good at gauging where the line of impropriety is and for all I know, maybe the help I'm offering you with these letters is unwanted. Maybe you are perfectly fine without any help.  
>
> It's been a bit a moral quandary for me as I've written these, as I am fairly certain your uncle didn't want us to "assist" you on your quest... still if it was that important, I have to believe he'd have the foresight to specifically instruct us not to interfere, nothing ever deterred him from that level of supervision in the past and after working alongside him for over a decade, I like to at least imagine that we were friends and that I knew him well. In conclusion, I think he would have found the level of help I have offered well within the acceptable range.  
>
> I haven't spoken too much about him since his departure, and I know you didn't know him that well, but as soon as you're ready I'm going to have plenty of stories to tell. He was a fearless businessman with the greatest respect for invention. Of all the laboratories I've worked in, I can tell you Mount Holly was a gem... and I'm hoping that we can continue that work once you've taken up the reins.  
>
> But I won't get ahead of myself. You still have to find the forty-sixth room.  
>
> -  
> Randolph  
...
### Mailroom Letter 6
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Randolph%27s_Letter_6>
...
>
> About a week before Sinclair died, something rather curious happened. A few lab assistants were called by Mrs. Babbage, the house manager, to remove several floorplans from Sinclair's Drafting Studio. Typically all of the unused floorplans are kept there and I have never heard of them being moved to another location, nor would I presume to guess the reason for such an action. I'm not sure which floorplans were removed or where they were moved to, save one, which I was instructed to remove myself.  
>
...
### Mailroom Letter 7
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Randolph%27s_Letter_7>
...
>
> It's important to note here, that in my own experience, I have found every other member of the staff to be extremely trustworthy and unwavering in their loyalty to your uncle.  
>
> Still, after that incident, we decided to err against our own confidences and opted to install a state of the art security system, issuing keycards to only the most trusted members of the senior staff.  
>
> If you find the security doors become an annoyance while you are attempting to navigate the house, you should be able to lower their frequency from the Security terminal and there is even a nifty trick to unlock them by utilizing the Utility Closet in conjunction with the security settings.  
>
> -  
> Randolph  
>
...
### Mailroom Letter 8
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Randolph%27s_Letter_8>
...
### Mailroom Letter 9
Location: Mail Room
Wiki: <https://blue-prince.fandom.com/wiki/Randolph%27s_Letter_9>
...
>
> This information is actually as much for me as it is for you, as I often spend ten minutes in the Utility Closet just pressing random buttons until coming up with the desired result but I rarely understand exactly how it is I get there!  
>
> After half an hour on hold, I finally got to speak to the technician who personally designed the system and compiled a list of helpful operating instructions. I'll add that material on a seperate sheet I'll include with this letter.  
>
...
### Realm & Rune
Location: Bookshop
Wiki: <https://blue-prince.fandom.com/wiki/Realm_%26_Rune>
**Borrowers**

| Date       | Borrower       |
| ---------- | -------------- |
| 1998-12-09 | Simon P. Jones |
| 2004-02-01 | Simon P. Jones |
...
>
> The Core  
> - small pentagon shape (diagram)  
>
> The Dividing Lines (Rays)  
> - radiating dividing lines (diagram)  
>
> The Motes  
> - small scattered star-like marks (diagram)  
>
> The Border  
> - decorative outer ring (diagram)  
>
> 1. THE CORE  
>
...
>
> - Naval capabilities. Ship routes. Seaports. The eight rays on these sigils resemble the directions on a compass rose.  
> - Roads. Streets. Carriages. The four rays here look like crossroads on a map.  
> - Horseback. Rough trails. Another sigil that uses four rays, however, these will always be configured to suggest a horse galloping.  
> - Train system. Locomotion. The three rays here are used in sigils for realms that rely on track based travel.  
> - Aviation. Dirigibles. Balloons. The five rays here suggest travel "above" the horizon.  
> - Camels. Pack mules. Arid or desert trails. Two rays to indicate a flat terrain.  
> - Turtleback travel. Five short rays that do not fully extend from the core to the border.  
>
> WEATHER  
> (the style of ray)  
>
...
>
> Straight black lines indicate a lack of unusual or harsh weather and normal temperatures.  
>
> FOGGY or misty weather is indicated when the ray has several horizontal slashes across one side.  
>
> Wavy lines are used to indicate extreme HEAT. The scorched air and blazing sun cause the otherwise straight rays to appear shimmering.  
>
> A RAINY realm is indicated with rays of three vertical lines pouring down.  
>
> For more extreme STORMY weather, a jagged lightning shaped ray is used.  
>
> A ray dotted with falling circles is used for colder realms in which SNOW is a common occurence.  
>
> WINDY weather is displayed on sigils by the use of bent curved lines, rays buckling under the high winds.  
>
> 3. MOTES  
>
...
>
> - Tribal – A primitive realm. Hunter and gatherers.  
> - Agricultural – Harvest and farming based society and culture.  
> - Martial – Militaristic nation engaging in generation spanning wars and heated arguments.  
> - Metropolitan – Large city-state with a dense, urban and populous center.  
> - Academic – A center for knowledge, advanced in various scholarly pursuits. These realms are home to many schools, universities and libraries.  
> - Industrial – Engineering driven culture with a focus on manufacturing, invention and production.  
> - Spiritual – An elevated reverence for nature, animals and the forces that guide us.  
> - Poetic – A strong focus on the advancement of the arts, writing, music, and language.  
>
> 4. THE BORDER  
>
...
>
> [Diagrammatic page: a full circular border pattern labeled white, alongside border segment samples labeled black, red, violet, pink, green, yellow, orange, and white.]  
>
...
>
> [Diagram of a complete example sigil]  
>
...
> Inside cover / borrower card: Dec 9 '98 — Simon P. Jones; Feb 1 '04 — Simon P. Jones. Pages 15-20 pending second-pass verification.  

### Realm & Rune (Worn out)
Location: Precipice
Wiki: <https://blue-prince.fandom.com/wiki/Realm_%26_Rune_(Worn_out)>
...
> [...]  
>
> [...ars of the first era found...ings, either of a natural...alting from the creations of...ere accustomed to record various signs with the aid of  
> They did this in order that the of their realm might not be erstood by strangers.]  
>
> Historically speaking, sigils are not a new tradition. They have been found in every era and every culture and predate both written text and heraldic arts. However, today when we use the term “sigil” we are referring specifically to Realm Sigils, those crude circular marks of designation found on royal artifacts, buildings and older documents.  
>
> This book was written to make simple the understanding of these fascinating glyphs and to clearly display the correlation between each sigil and the iconography of that realm’s royal art. “How is the image of a leafless burning tree seen in geometric lines and what does that tell us of a Kingdom’s history?” Each line, each circle, and each variation tells a story of the land. Even the adorned borders around the sigils have special meaning.  
>
> [Diagram: circular sigil with decorative outer border, divided interior, small triangular marks, and central diamond.]  
>
> THE SIGIL  
>
> To understand a Realm Sigil, we must first dismantle the symbol and identify the individual elements that make up the whole.  
...
> (icon) Fe[...]  
>
> (icon) [...]me STORMY weather,  
> [...] shaped ray is used.  
>
> (icon) Con[...] falling circles is used [...]s in which SNOW is a [...]ence.  
>
> (icon) An[...] [...] is displayed on sigils [...] bent curved lines, rays [...] the high winds.  
>
> 1. THE R[...]  
>
> [...]ties. Ship routes. [...]eight rays on these [...]e the directions [...]rose.  
>
> [Diagram: eight-pointed ray symbol.]  
>
> [...]s. Carriages. [...]here look like [...] a map.  
>
> [...]ugh trails. Another [...] four rays, however, [...] be configured [...] horse galloping. [...] Locomotion. [...] rays here are used [...] for realms that rely [...] track based travel.  
>
> Wavy lines are used to indicate extreme HEAT. The scorched air and blazing sun cause the otherwise straight rays to appear shimmering.  
>
> A RAINY realm is indicated with rays of three vertical lines pouring down.  
...
> Agricultural - Harvest and farming based society and culture.  
>
> Martial - Militar[...] [...] in generation spanning arguments.  
>
> Metropolitan - Large city-state with a dense, urban and populous center.  
>
> Academic - A center for knowledge, advanced in various scholarly pursuits. These realms are home to many schools, universities and libraries.  
...
> Around each sigil is an adorned edge serving as a container for the information within. There are eight different borders, each one corresponding to a different color. These borders always correspond to the banner and national colors of that specific realm.  
>
> [Diagram: circular border pattern labeled “white.”]  
>
> [Diagrammatic page showing 8 border samples labeled:]  
> - black  
> - red  
> - violet  
> - pink  
...
> By studying the core, rays, motes and border of a sigil, you should now be able to unlock the meaning behind what had previously been an undecipherable enigma.  
>
> [Diagram: full sigil with patterned border, central core, rays, and mote symbols.]  
>
> [Handwritten notes:] Red Banners  
>
> Martial  
>
> Fog  
...
Location: Unknown
Source: Worth Laude
Wiki: <https://blue-prince.fandom.com/wiki/Red_Letter_1>
...
Location: Study
Source: Caleb
Wiki: <https://blue-prince.fandom.com/wiki/Red_Letter_2>
...
> M,  
>
> Be prepared for our plans to be set in motion in a month or two. It's all lining up and all of our hard work is about to come to fruition. I have just learned that several members of the Museum's guard are sympathetic to our cause. We suspect two more to be pure opportunists whose loyalty extends only to their coin purse.  
>
> Your uncle has already agreed to let us use Mt. Holly's "flexible" floorplan for a trial run, assuming the redprint we have secured of the museum's 'Closed Exhibit' is in fact accurate and up to date.  
>
> We should begin these trials without delay once you arrive. If you can within the next two months fabricate some fiction that might alleviate us of the presence of the servant staff.  
>
...
### Red Letter 3
Location: Unknown
Wiki: <https://blue-prince.fandom.com/wiki/Red_Letter_3>

Transcript:

> Red Letter 3 General Spoilers Type Letter Location Unknown Previous Next Red Letter 2 Red Letter 4 Red Letter 3 is the one and only Red Letter whose location remains a mystery. As told in Alzara's Forecastings, this letter cannot be found by the player.  

### Red Letter 4
Location: Boudoir
Source: Daniel
Wiki: <https://blue-prince.fandom.com/wiki/Red_Letter_4>
...
Location: Drafting Studio
Source: Mary
Wiki: <https://blue-prince.fandom.com/wiki/Red_Letter_5>
...
Source: Herbert
Wiki: <https://blue-prince.fandom.com/wiki/Red_Letter_6>
...
>
> As for me and you, I have already come to terms that our meeting yesterday was likely our last.  
>
> I am too old and too stubborn to ever leave this place. I am too attached to the home our family has built up, room by room. Yes, I have a strong premonition I will be buried in red soil, under red flags. A compromise I know you yourself would never accept.  
>
...
>
> I now have reason to believe that you were in fact responsible for smuggling my cousin under cover of night across the red border to the southern seafront. And I believe this may have occurred in September, a full 7 months after she was reported missing. A date that coincides not with her public "disappearance" in February but instead with the notable theft of the Ruby Crown.  
>
> If the Black Water insurgents were in fact responsible for the heist as some have claimed, I believe this scenario entirely plausible. And the fact that 2 of the crown's eight rubies have now surfaced has given me renewed optimism that she is still alive.  
>
...
Location: Office
Source: X
Wiki: <https://blue-prince.fandom.com/wiki/Red_Letter_8>
...
>
> And while I'm guessing you had hoped to never hear from us again once we had given you back the envelopes, we felt that one final red letter of our own was merited given the circumstances. Hopefully, you will not be as careless with this missive as you were with the others.  
>
...
### Red Letters
Wiki: <https://blue-prince.fandom.com/wiki/Red_Letters>
...
### Remain-in-Place Letter
Location: Shelter
Source: Unknown (prob. Randolph Moore)
Wiki: <https://blue-prince.fandom.com/wiki/Shelter_Note>
...
### Room 46 Deed
Location: Room 46
Wiki: <https://blue-prince.fandom.com/wiki/Room_46_Deed>

Transcript:

> Certified Copy PROPERTY DEED.  
> Lord Arthur Clementine to Lady Auravei of Trinsdale  
>
...
>
> that LORD ARTHUR CLEMENTINE, rightful owner of the land that rests in the northern range of the Reddington Mountains, doth grant and convey to the bearer of this document, LADY AURAVEI OF TRINSDALE, the land, forest, and waters of the sheer cliffs that rest in the northern shadow of the  
> "holly leaf mountain", with all the rights, privileges, and appurtences thereunto belonging.  
>
> Boundaries  
> The property of MOUNT HOLLY, consists of dense woods, flanked by cliff walls, irrigated by mountain spring streams and punctuated by several runoff waterfalls. This area is sheltered between the summit's northern slope and saddle, spanning across 80 ODD ACRES of land. The property is situated south-west of Reddington, bounded on the south by steep crags, and abutting the east by the high-road to Tanner Fork.  
>
> Covenants  
> I, LORD ARTHUR CLEMENTINE, covenant, promise and agree with LADY AURAVEI, her heirs and assigns, that I am lawfully seized and possessed of the said premises, that the same are free and clear of all encumbrances, that I have good right to sell and convey the same to the said Lady Auravei, her heirs and assigns, and that I will warrant and defend the same against all lawful claims and demands whatsoever.  
>
> In hand and seal, I make my mark, in the grand year of Fenn Aries, Nineteen Hundred and Twelve.  
>
> Lord Arthur Clementine  

### Room 46 Note
Location: Room 46
Wiki: <https://blue-prince.fandom.com/wiki/Room_46_Note>
...
Color: Blue
Cost: 1 gem
Type: Blackprint / Blueprint

Room Description:
In addition to having a bouquet of colorful fish swimming within them, each tank in the Aquarium is also inspired by the decor and colors of the various types of rooms found throughout the estate, including one or two red herrings.
...
Room Description:
A familiar room that you may have slept in at some prior visit in the past. Like most bedrooms of the estate, these quarters offer you a little rest and recuperation during your long days exploring the surrounding rooms.
...
Room Description:
A private salon with a plethora of fainting couches and chaise lounges that served both as a dressing room for her Ladyship in the mornings and a cozy sitting room for her in the evenings.
...
Room Description:
The rustic, wooden stacked bunk beds evoke the enticing promise of campfire stories and childhood adventures. This bedroom served as a pillowfort and bedroom to the young Sinclair boys, and has remained faithfully unchanged over the years.
...
Room Description:
The Mount Holly Casino offers an intimate and exciting setting for wagers of any scale, and guests may be surprised to discover how much strategy is involved in the games featured here. A buy-in of two Gems is required for admittance into this exclusive room.

### Room: Chamber of Mirrors
Color: Blue
Cost: 0 gems
Type: Blueprint / Dead End

Room Description:
Reflections of reflections, this confusing room can sometimes prove disorienting to the wayward guest. However, upon closer inspection, they quickly realize that viewing this room from more than one perspective is key to unraveling its secrets.

Blue Tents Note:
IF AN ITEM WOULD BE SPREAD INTO THE CHAMBER OF MIRRORS, FOUR OF THOSE ITEMS ARE SPREAD INSTEAD.
...
Room Description:
A private sacristy, as ornate as the most lavish rooms of the estate, is watched over by eight Ajeran Angels depicited in stained glass. This room was more a tribute to your uncle's vanity than it was to his faith.

### Room: Classroom
Color: Black
Cost: 1 gem
Type: Addition / Blueprint

Room Description:
An exact copy of the floorplan used in the architectural design of Reddington Elementary. These copies were deployed in Mt. Holly as a short term solution, to allow the curriculum to continue uninterrupted while the new school was being built in town.

Blue Tents Note:
( Final Exam ) THE ANSWER OF THE EXAM'S FINAL QUESTION IS EQUAL TO ITS NUMBER.

### Room: Clock Tower
Color: Black
Cost: 1 gem
Type: Addition / Blueprint / Dead End

Room Description:
Access to Mt. Holly's clock tower has always been heavily restricted. Time is sacred and any tampering of the estate's governing timepiece has never been risked.
...
Room Description:
A very modest recessed space used for storage. This particular closet is favored by the junior members of the staff, who utilize it to stash away assorted articles and knicknacks whose proper place in the estate is yet unknown to them.

Blue Tents Note:
THE CLOSET WAS ONE OF THE ORIGINAL 46 ROOMS OF MOUNT HOLLY.
...
Room Description:
In his later years, H. S. Sinclair had become withdrawn from public life and conducted all business from the comfort and privacy of home. This included the occasional board meetings which were held in the professional setting of this room.

Blue Tents Note:
RED MEMOS WERE CREATED BY KIRK DARREN AND APPROVED BY THE BARON AND QUESTIONABLY SERVED AS THE STATE'S PRIMARY SECURITY SYSTEM.
...
Room Description:
A long hall with two doors at either end that had been one of your uncle's most frequently traveled rooms. Consequently, he had left strict instructions with the household staff that the doors of this corridor should never under any circumstance be locked.
...
Color: Black
Cost: 1 gem
Type: Addition / Dead End

Room Description:
These small sleeping quarters, devoid of frills and distractions, are ideal for the student, scholar or denizen of academia who wish to focus on their studies without interruption. Study and sleep. Rinse and repeat.
...
Room Description:
As an architect and engineer, it was not uncommon to find your great uncle spending the better part of his weekends here, at a drafting table with a T-square and compass in hand. Over half of the floorplans of Mt. Holly were conceptualized, refined and drafted in this studio.

Blue Tents Note:
The full directory is comprised of 46 numbered rooms plus eight categories of eight rooms. 46 + <46> (diamond symbol, meaning digit inversion : 64)
...
Room Description:
This fenestrated hallway overlooks the east side of the estate grounds and is warmed in the early day by the light of the rising afternoon sun.
...
Room Description:
The grand baroque hall of Mt. Holly is impressive to behold. This ornamented passage is flanked with marble pillars and bust statues of the more prominent figures of the Sinclair family legacy.
...
Blue Tents Note:
THE ICE IN MASTER SINCLAIR'S PERSONAL FREEZER CAN ONLY BE THAWED BY APPLYING A DIRECT HEAT SOURCE.
...
Room Description:
The main centralized heat source for the estate. You may find yourself starting to sweat after drafting this room.
...
Room Description:
A half-court intended for basketball and racquetball which is seldom used by anyone apart from the junior staff during their lunch hour. At least they did before Mrs. Babbage disallowed the practice after noticing how worn out staff members were after a game.
...
Room Description:
One of the many nondescript hallways snaking through the estate and providing elegant causeways between the more noteworthy destinations that the house has to offer.
...
Room Description:
Tucked quietly away in the west wing of Mount Holly is the decorative bedroom of your grandmother, Lady Epsen. The style you find, unique in the house, a fitting tribute to her childhood home in Eraja.
...
Room Description:
A standard kitchenette with all the typical amenities: a stove, refrigerator, oven and sink. This gallery is where the cooking staff prepares the daily cuisine that will later be served in the Dining Room .
...
Room Description:
A standard hub of domestic toil complete with washers, dryers and a state of the art steam-powered unit leveraging the newly installed steam ducts leading from the boiler room. Despite its innocent appearance, this inconspicuous place is rumored to launder more than just linen.
...
Room Description:
A room one might go to great lengths to avoid showing guests despite them always probing for its location.
...
Room Description:
There has always been a history of things disappearing on the estate, including this very floorplan, which had been lost for many years itself and missing from the directory. Now that it has been found, some long lost items from Mount Holly's past might finally resurface...
...
Blue Tents Note:
ONLY SIX OF THE NOTORIOUS " RED LETTERS " WERE ADDRESSED TO HERBERT S. SINCLAIR.
...
Room Description:
An iron vaulted mechanical chamber affixed with motorized panels that can reveal up to 8 different doors depending on the parameters at the time of creation.
...
Blue Tents Note:
THE LARGEST PLANET IN THE NIGHT SKY IS NAMED AFTER THE PARAGON OF ASH.
...
Blue Tents Note:
THE GEMS ARE IN THE [BLUE/WHITE/BLACK] BOX.
...
Room Description:
A long series of unfinished passages used primarily by the servant staff to traverse the estate quickly.
...
Room Description:
A circular theatre featuring a dome shaped projection screen upon which scenes of the stars and galaxies allow viewers to experience the splendor of the heavens.
...
Room Description:
An underground store of jarred vegetables and fruits from Mount Holly's gardens. It's always amazing what great things come from a little digging around in the dirt.
...
Room Description:
A uniquely modern fashioned gaming room, the Rumpus Room has provided many guests of the estate with countless hours of recreation. The room is outfitted with a record player, two television sets, a collection of board games and a mysterious antique fortune telling automaton named "Alzara".
...
Room Description:
A traditional wood-lined Corarican style sauna, temperature controlled and exceptionally relaxing. The invigorating effects of this room will leave you waking up the next day feeling rejuvenated.
...
Room Description:
A floorplan so secretive it had been removed from the drafting pool to avoid anyone unwanted accidentally stumbling on it. This secluded garden, flanked by a variety of Mora Jai fruit trees, has served as a private retreat to at least two other generations of Sinclairs.
...
Room Description:
A small "Dead End" room with an ordinary bookcase, that exemplifies that the best means to escape the confinements of our world has always been through books.
...
Room Description:
A quaint floral sitting room surrounded entirely by tinted glass panes. This room is ideal for tea in the afternoons or getting some sun without the hassle of going outside.
...
Blue Tents Note:
THERE ARE TWELVE DIFFERENT POTENTIAL SPARE ROOM UPGRADES.
...
Room Description:
A dedicated storage space filled from end to end with a surplus of chairs, carpets, paintings and a handful of other things that had at one time been in vogue and on display elsewhere in the house.
...
Room Description:
A terrace balcony overlooking the grounds providing an ideal spot for appreciating all the verdure and greenery that the estate offers.
...
Room Description:
A stone chamber fitted with ancient weapons and armor from the Second Era. This room appears to predate almost every other room in the house directory and may in fact be an authentic floorplan from one of the lost strongholds of Orinda Aries.
...
Room Description:
Home to several of Sinclair's hunting companions. It can be assumed these friendly hounds have been anxious to meet their new master.

Blue Tents Note:
SINCLAIR'S FOUR CANINE COMPANIONS ARE NAMED CARTER, THOUGHTLESS, HOT SAUCE AND DRAWBRIDGE.
...
Room Description:
An indoor Orindian pool was one of the more modern additions to the estate, the inclusion of which provided a convenient excuse for building a handful of other rooms which not only complement an indoor pool, but are often compulsory inclusions.
...
Color: Black
Cost: 5 gems
Type: Addition / Blackprint

Room Description:
The former seat of power of Orinda Aries before the current era and the rise of the red banner.

### Room: Tomb
Color: Outer
Cost: 0 gems
Type: Blackprint / Dead End
...
Room Description:
A simple shed with a variety of tools used by the groundskeepers in the course of their duties.
...
Room Description:
An outpost established on the outskirts of Mount Holly in the era before the new realms. This station allowed the frontiersmen and trappers of these mountains to trade goods and services with the state, the locals and one another.
...
Room Description:
The polished brass of the treasured laurels filling the trophy cases of this room reveal the pride their owner must feel having earned them. Achievements is its own reward but a gold cup is also nice.
...
Room Description:
Going under all obstacles, the tunnel pierces through walls and rooms alike. This crudely excavated passage looks to be the work of someone determined to get where they are going regardless of whether the house's floor plan is accommodating or not.
...
Blue Tents Note:
D.C. POWER'S DESIGNS FOR THE V.A.C. CONTROLS WERE PARTLY INSPIRED BY THE GIFT THEY RECEIVED FROM THEIR CLIENT: AN ORIGINAL MORA JAI BOX.
...
Room Description:
This relaxing breezeway serves as an ideal spot for rocking chairs and lemonade.
...
Room Description:
An ornately framed yet modestly sized hall. It had served as the original antechamber in the old days before eventually being removed from the estate for having doors that were prone to becoming stuck.
...
Room Description:
The stylish and smart clothes in this generously sized closet belong to the former Mistress of the estate, Lady Epsen. Though the small dressing room has not been used in many years, it is nevertheless kept up and preserved in the state you now find it.
...
Room Description:
A short staircase leads down to this below ground cellar revealing an impressive collection of bottles from every respectable vintage of the last 200 years. To the seasoned wine aficionado, the labels displayed here would indicate a preference for prioritizing extravagance and rarity over quality.

Blue Tents Note:
THE NUMERALS BELOW THE COAT OF ARMS ARE FOUR DIFFERENT NUMBERS, NOT ONE.
...
Wiki: <https://blue-prince.fandom.com/wiki/Root_Cellar_Family_Tree>
...
### Root Cellar Message
Wiki: <https://blue-prince.fandom.com/wiki/Root_Cellar_Message>

Transcript:

> SEARCH CONTINUES  
>
> author and illustrator whose fanciful stories name Marion Marigold, was last seen by a m Friday getting into a carriage after a late  
>
> no sign has been found (yet)  
>
> X Y Z A B C  

### Rotating Gear Mining Logs
Location: Rotating Gear
Source: Scripps & Rudford Mining Company
Wiki: <https://blue-prince.fandom.com/wiki/Rotating_Gear_Mining_Logs>
...
> SCRIPPS & RUDFORD MINING COMPANY EXCAVATION DEPARTMENT  
>
> FOREMAN'S LOG: [illegible]          DATE: 3.1.1917  
>
> After 10 days of pumping water up from the underground spring, the reservoir has finally been filled. It's a shame that the old station had to be flooded as a consequence of this action, but I suspect that may have been the actual reason they chose to build the reservoir here and as an engineer I agree that flooding is preferable to collapsing the entire tunnel.  
>
> On the bright side, now that our water supply is no longer limited, we can start to leverage steam to a much greater extent. I suspect by this time next month, the steam-powered hoists at the main site will be able to run 24 hours a day.  
...
### Safehouse Letter
Location: Safehouse
Wiki: <https://blue-prince.fandom.com/wiki/Safehouse_Letter>
...
### Safehouse Museum Plan
Location: Safehouse
Wiki: <https://blue-prince.fandom.com/wiki/Safehouse_Museum_Plan>

Transcript:

> The Royal Museum of the Grand City of Fenn Moonside Courtyard (G): Quietly hidden on the west end of the grounds, tucked away from the bustle of the guided museum crowds.  
> Leerson Hall (A, R): The restored original home of Prince Leerson, donated to the City of Fenn upon his death, now serves as the Royal Museum's beautiful West Annex.  
> Parking Lot - West (P): For special events of a certain magnitude, the lot west is opened to serve for overflow parking should the main south lot be at maximum capacity.  
> Closed Exhibits (A, R): Both Leerson Hall and the Main Concourse feature a number of quote '  
> Closed Exhibits  
> ' which are reserved for the upper tier of elite patronage an are not currently open to the public for admission.  
> This is circled in red.  
> "roof access?" Garden Pathway (G, F): Enjoy a leisurely stroll on one of our many winding garden pathways, which can be accessed from both a west and south entry and are free to use without ticket purchase.  
> Museum Station Cafe (S): Further west, the Royal Museum's dedicated and now defunct train station sits and has been converted into a restaurant for our patrons to enjoy after visiting the museum.  
> "As cool as this would be its too easy to track (literally)" Museum - Main Consourse (A, T): Ascend the historic steps and be a part of history. The Royal Museum's Main Concourse, built on the former estate of Prince Leerson, has served as the realm's central hub of art and culture for over 100 years.  
> "Decoy Car" Public Exhibits (A, T): One ticket grants you access to all of the Royal Museum's Public Exhibits, most of which celebrate a legacy of artists and paintings showcasing the color red.  
> Tiskin Monument (G): A monument of the victorious King Tiskin, adorned with sword, shield and wings. Made to commemmorate the end of the War of the Fifth Era.  
> Museum Grounds (G, F): Open to the general public, the museum grounds host a variety of verdure as well as a number of sculpted pieces of contemporary art.  
> Plans in Red Timeline  
> 1:05 - White, Farro, and Marigold stand at the edge of the Museum Grounds.  
> 1:10 - Manning approaches from the East Grounds.  
> 1:24 - White enters the guard house at the northern end of Leerson Hall. Farro and Marigold force entry through the east door to the staff room (the scribbled number was 1:05).  
> White acesses the security controls behind the exhibit. After acquiring the crown from the Closed Exhibit, the Escape Route is through the King's Grotto.  
> 1:36 - They leave by the Getaway Car at the Northwest corner.  
> Behind the Closed Exhibit  
> The tiny red text reads "System Security Controls". This is also a hint on how to access the Paper Crown within the Closed Exhibit room on the estate.  

### Schoolhouse Note
Location: Schoolhouse
Wiki: <https://blue-prince.fandom.com/wiki/Schoolhouse_Note>
...
### Scrapbook
Wiki: <https://blue-prince.fandom.com/wiki/Scrapbook>

Transcript:

> Mount Holly Scrapbook Mount Holly Scrapbook  
> The scrapbook is on the second floor of the Library that tracks the player statistics and achievements.  
> Contents  
> 1  
> Contents  
> 1.1  
> Claim Ticket and Checked Items  
> 1.2  
> Contraptions  
> 1.3  
> Drafted Floor Plans  
...
### Sealed Entrance Document
Location: Unknown
Source: Fenn Aries Patent Office / Scripps & Rudford Mining Co.
Wiki: <https://blue-prince.fandom.com/wiki/Sealed_Entrance_Document>

Transcript:

> FENN ARIES PATENT OFFICE  
>
> PATENT NUMBER  
> 68642  
>
> SCRIPPS & RUDFORD MINING CO.  
> PATENT FOR HIGH PRESSURE CONDENSER  
...
### Sealed Entrance Mining Log
Location: Sealed Entrance
Wiki: <https://blue-prince.fandom.com/wiki/Sealed_Entrance_Mining_Log>

Transcript:

> SCRIPTS & RUDFORD MINING COMPANY EXCAVATION DEPARTMENT  
>
> FOREMAN'S LOG:  
> 289  
> DATE:  
...
### Secret Archives Cabinet Certificate
Location: Archives
Wiki: <https://blue-prince.fandom.com/wiki/Secret_Archives_Cabinet_Certificate>

Transcript:

> East Reddington Hospital CERTIFICATE OF BIRTH This document attests that Mary Matthew Epsen was born to Lady Clara Epsen and Simon H. Sinclair in this Hospital at 4:05 am Tuesday the 22nd day of January in the Sixth Era, 1958  
...
> Doctor: Lilly Rysian Rose  
> Registrar Officer: Sarah Drivian  

### Secret Archives Cabinet Newspaper
Location: Archives
Source: Reddington Herald
Wiki: <https://blue-prince.fandom.com/wiki/Secret_Archives_Cabinet_Newspaper>
...
>
> The red flags flying over the capitol was a bittersweet sight of comfort for many of this realm's war-weary citizens. After twenty-two years, peace had come at last. We, the staff of the Reddington Herald, join all of the citizens of Reddington in welcoming this new era of peace, and formally retract and disavow all prior printed support of House Desilets.  
>
...
>
> Final page - partial solution for the Eraja Realm Sigil.  

### Secret Tomb Letter
Wiki: <https://blue-prince.fandom.com/wiki/Secret_Tomb_Letter>
...
> Nevdau eldareilu. Ajelbid ulheed eldlor: Uloddiris. Hewsinclairlu. Hewepsenlu. . . Forget uldein inn. Uldjorjeari.. Uldarei oviss fennvo. Uldeinjorovo. Overaja. Oviss nevarei.  
> Lorja eldiris,  
> Uldjora Letter Translation (literal)  
> Ov|eld|aj|iris,  
> Towards my first child,  
> Ul|eld|dau, ul|eld|nai, ul|eld|mora.  
> You my day, you my night, You my world.  
> Ov|ul|el|gift eld|hew ov|iss. Nev|dau uld|arei|le.  
> Towards you I gift my house towards south. New day your future without me.  
> Nev|dau eld|arei|lu. Aj|el|bid ul|heed eld|lor: Ul|odd|iris.  
> New day my future without you. First I bid you heed my word: you <odd> child.  
> Hew|sinclair|lu. Hew|epsen|lu... Forget uld|ein inn. Uld|jor|jeari... Uld|arei ov|iss fenn|vo. Uld|ein|joro|vo. Ov|eraja. Ov|iss nev|arei.  
> House Sinclair not you. House Epsen not you... Forget your dream north. Your name Je Ari... Your future towards south away from Fenn. Your dream away from father. Towards Eraja. Towards south new future.  
> Lor|ja eld|iris,  
> Last word my child,  
> Uld|jora Your mother (See the Erajan page for a list of word translations) Letter Translation (interpreted) My dearest first child,  
> You are my day, you are my night, you are my whole world.  
> To you, I gift my southern house. Tomorrow is the dawn of a new future without me.  
> Tomorrow I will leave you. But first, I bid you to heed my words: you are a foreign* child. You are not House Sinclair. You are not House Epsen... Forget your dreams in the north. Your name is Je Ari... your future is in the south, away from Fenn. Your dreams are not your father's. To Eraja. Towards a new future in the south.  
> Farewell, my child,  
> Your mother  
> *The meaning of this word is unclear. 'Foreign' and 'noble' are the leading candidates for translation. See Erajan for more info.  
> Parties  
> This is a letter from Clara Epsen, presumably near death, to her daughter Mary Jones. The letter is in Clara's handwriting, and Mary is the only member of both house Sinclair and house Epsen (aside from her son Simon, the protagonist).  

### Security Blue Memo
Location: Security
Wiki: <https://blue-prince.fandom.com/wiki/Security_Blue_Memo>
...
### Security Footage
Wiki: <https://blue-prince.fandom.com/wiki/Security_Footage>
...
> 1987  
> 2 - 09 - 10:59 AM - LIBRARY  
> Shows a man and a woman in the Library. The woman is sitting at the table with a book open. The man brings another book from the bookshelf and shows it to the woman. It seems like they check out its contents together.  
> 2 - 09 - 12:01 PM - ENTRANCE  
> Shows a person entering the Entrance Hall from the East Wing, carrying a vase, heading towards main entrance. We can't see what happens to the vase.  
> 2 - 10 - 4:22 PM - SECURITY  
> Shows Mary Jones in the Security room. She brings a sheet of paper to show up close to the security camera. The paper has a drawing on it.  
> 1993  
> Recordings from 1993 are cutscenes that played throughout the game. It is possible to rewatch them here.  
> Other years There are no recordings.  

### Security Red Memo
Location: Security
Wiki: <https://blue-prince.fandom.com/wiki/Security_Red_Memo>
...
### Servant's Quarters Memo
Location: Servant's Quarters
Source: Unknown
Wiki: <https://blue-prince.fandom.com/wiki/Servant%27s_Quarters_Memo>
...
### Servant's Quarters Note
Wiki: <https://blue-prince.fandom.com/wiki/Servant%27s_Quarters_Note>
...
### Solarium Note
Location: Solarium
Wiki: <https://blue-prince.fandom.com/wiki/Solarium_Note>
...
> Sympathetically,  
> Bridgette Cloister Grounds Access  
> While face-to-face with the angel, press the base of the two pillars on either side of you.  

### Staff Announcements
Wiki: <https://blue-prince.fandom.com/wiki/Staff_Announcements>
...
Wiki: <https://blue-prince.fandom.com/wiki/Star_Schedule>

Transcript:

> Star Schedule  
> Survey of Constellations observed at the Mt. Holly Observatory  
>
> CONSTELLATIONS  
>
> 1  North Star  
...
> 24 Diamondus Minor, Florealis - Bloom of the Sky  
> 25 The Twins, The Slice, Southern Cross, Farmer's Apple, Clavis  
>
> Other notable night skies observed:  
>
> 29 - First appearance of both Diamondus Minor and Major in the same sky.  
>
> 40 - Seven different Constellations observed in a single night.  
>
> 50 - New Constellation spotted!  

### Study Notes
Location: Study
Wiki: <https://blue-prince.fandom.com/wiki/Study_Notes>
...
### Swim Bird
Location: Library
Wiki: <https://blue-prince.fandom.com/wiki/Swim_Bird>
**Borrowers**

| Date       | Borrower                               |
| ---------- | -------------------------------------- |
| 1985/07/02 | Herbert Sinclair                       |
| 1985/07/12 | Mrs. Peterson                          |
| 1985/11/01 | Mrs. Peterson                          |
| 1985/12/24 | Simon (likely 6-year-old Simon Jones ) |
| 1986/01/26 | Mrs. Peterson                          |
| 1986/04/01 | Anne Babbage                           |
| 1987/03/02 | Det. Bon Margle                        |
...
### The Blue Prince
Wiki: <https://blue-prince.fandom.com/wiki/The_Blue_Prince>
...
### The Blue Testament of Auravei
Wiki: <https://blue-prince.fandom.com/wiki/The_Blue_Testament_of_Auravei>

Transcript:

> The last WILL and TESTAMENT,  
> of me,  
> The Baroness Auravei  
> I, Auravei of Mount Holly, architect, mother, and reluctant baroness, being weak of body but of perfect mind and memory, thanks be to Orinda, do make and ordain this document my last will and testament; As I commit my final wishes to paper, may it be done so in the tapestly and color of my life's work. May it be written under the tree of creativity and in the shade of truth that has sheltered my loved ones from the villainy of country and countrymen. In that same spirit of defiance, I hereby revoke all wills and codicils heretofore printed on common hueless parchment.  
...
> In the second order, should my husband,  
> Baron Tomas Sinclair, survive me, I grant to him his choice of sentimental keepsake he may wish to retain in remembrance of me. As our union was never founded on material dependency, I make no provision for his future, nor for my eldest son,  
> Herbert S. Sinclair, as he will, in due course, inherit his father's titles, enterprises and fortune. However, the estate of Mount Holly, its many floorplans, and storied secrets, are mine and mine alone to grant, and I have neither pledged nor suggested it will be granted to either of my children. (Further details concerning its disposition to follow.)  
> I do, in the third order, bestow upon my youngest son,  
> Simon, my library, including its books, manuscripts, and musings. For I have long believed that Simon, much like myself, finds greater delight in the realm of imagination than in the mundane realities of everyday life. I hope he cherishes these books, for within their pages lie doorways to endless worlds of wonder and knowledge.  
> In the fourth order - one that I suspect will intrigue those I leave behind far more than the previous provisions - I hereby bequeath the entirety of the aforementioned estate, Mount Holly, to the individual that discovers the hidden room that contains the blue pages of this document, hence styled  
> The Blue Testament of Auravei. It is my firm belief that the challenge of uncovering this secret far outweighs any other measures of worthiness and thus, I entrust my beloved home to that deserving successor, without regard to the years that may pass or their familial connection to my descendants who may have incidentally assumed possession of the estate in the interim.  
...
> I do hereby constitute and appoint my colleague and fellow practitioner of architecture,  
> Quarteress Alicias Erin of Trinsdale, the exclusive charge and office of executrix of this instrument. If ever the forty-sixth room of my Mount Holly is discovered and  
> The Blue Testament of Auravei be delivered unto her hands, or unto any of her descendants, I do ordain that they shall bear sole dominion and discretion to override and render null any and all prior arrangements heretofore made in my stead or in the name of my seed. I trust in her, and in the generations that follow her, to fulfill this role faithfully, in steadfast adherence to the wishes laid out in the foregoing pages of this document.  
> Lastly, I leave a final message to my worthy successor-you, who have reached this final room. You, who unearthed these pages hidden amidst the blueprints, buried beneath cryptic words and the prophecies of the past.  
> You, who have spent countless days wandering the chambers and passageways of your own curiosity. Scouring for clues. Hoping for answers. Striving for that which you knew might forever elude you. To you, for whom satisfaction is a fleeting companion. To you, who stands now at the end of your journey- triumphant, exhausted, and justly proud. To you, I grant that which, in life, I have given to no other: My esteem.  
> In witness whereof, I have hereunto set my hand this 16th day of April 1952,  
> Auravei of Mount Holly  

### The Curse of Black Bridge
Location: Bookshop
Wiki: <https://blue-prince.fandom.com/wiki/The_Curse_of_Black_Bridge>
...
>
> Ravia touched her elbow and pointed up.  
>
> Miller, striving to suppress a budding smile, subtly shook her head in response. There were many signs that the Unholy Hounds used in lieu of words, but the two of them had developed an extended vocabulary. Gestures quietly forged in the shared solitude of their month among the branches. She watched as Ravia shifted, placing her palms flat on the floorboards beneath them.  
>
...
>
> Miller closed her eyes tight and used her feet to guide her along the passage. The whispers around her were getting louder, and intense voices could be heard ahead. Louder speech than she had ever heard spoken in the canyon.  
>
> A growing dread grew as Miller approached the mouth of the cave. Her eyes now open wide despite the dust.  
>
> Shouldn't it be day?  
>
...
>
> [Note: middle of Part One had one OCR truncation around Jesper's reflection after killing the driver; otherwise substantial text recovered. Further later pages beyond this recovered section may still benefit from another pass if a fully verified end-to-end transcript is required.]  

### The Fixed Stars
Wiki: <https://blue-prince.fandom.com/wiki/The_Fixed_Stars>
**Borrowers**

| Date       | Borrower       |
| ---------- | -------------- |
| 1998-01-03 | Clara Epsen    |
| 1998-11-28 | Simon P. Jones |
...
>
> Author: Richard Witt  
> Publisher: Bird & Sons Publishing  
> Published: 1809  
>
> Preface:  
...
>
> Constellation/reference entries:  
> - North Star — Effect: +1 gold  
> - The Twins — Star count: 2 — Effect: Two trunks have been added to the Entrance Hall  
> - The Slice — Star count: 3 — Effect: +3 Steps  
> - Diamondus Minor — Star count: 4 — Effect: +1 Gem  
> - The Southern Cross — Star count: 5 — Effect: Rooms with four doors are more common today.  
> - Farmer’s Apple — Star count: 7 — Effect: Apples are extra delicious today  
> - Clavis, the Key — Star count: 8 — Effect: +1 Key  
> - Diamondus Major — Star Count: 11 — Effect: +5 Gems  
> - Draxus, the Dead — Star Count: 12 — Effect: Dead End rooms are more common today  
> - The Sail — Star Count: 15 — Effect: Everything is 50% off today  
> - Florealis, Bloom of the Sky — Star Count: 20 — Effect: Green Rooms are more likely to contain special "flowers" today.  

### The History of Orindia (1st ed.)
Location: Bookshop
Wiki: <https://blue-prince.fandom.com/wiki/The_History_of_Orindia_(1st_ed.)>

Transcript:

> The History of Orindia (1st ed.)  
>
> Author Caleb Manning Published on  
> 1979  
> Publisher Ruffington Red Publishing  
>
> FOREWARD  
> ORINDIA  
> was once the name used to designate the realms of the eastern waters. Though the term is no longer employed in the halls of politics, not commonly known to the average citizen, its memory flickers in the hearts of those who hail from the lands that it once encompassed, and many of the elder generation, in hushed circles, still refer to themselves as Orindians.  
>
...
>
> I AJERA  
> Most historians mark the beginning of the first era, often denoted as Ajera, by the ascension of the first king of Orindia whose name, Oris, would later grace the burgeoning township in which he was crowned.  
>
> Oris was known, before his coronation, as a prominent merchant lord of considerable means and affluence, whose sway in the region made him the ideal candidate for the unification of the surrounding provinces.  
>
...
>
> II SECOND ERA  
> It was the fourth king of Orindia who split this vast domain in equal shares. Three Realms for his three children.  
>
...
>
> IV FOURTH ERA  
> As the kingdom of Orinda Aries entered the fourth era, a different kind of ruler took the reins of power.  
>
> King Desilets III was a king who listened to the voices of all his subjects, from the most influential advisors to the humblest of citizens.  
>
...
>
> However, even with the tide turning in their favor, victory did not come easy. The War of the Fifth Era lasted 22 long years, and saw buried one in every three men. Prince Leerson himself added another number to the casualties. However, even in death, he had won.  
>
> Oris had fallen and with it the realm. The black flags that had flown for five eras were burned, and in their place, red banners were hoisted in honor of the fallen of Fenn. The five remaining members of the former royal family fled in fear of their lives to the south, forever exiled.  
>
> VI THE CURRENT ERA  
> Today, the realms inherited by The Three, FENN ARIES, ARCH ARIES and ERAJA once again stand united as allies. Though the distance between our peoples has grown, our connection to this land remains as strong as ever. The spruce and birch that span across our realms serve as a constant reminder that we all share a common past. And as those trees continue to grow, so do our hopes for a common future. A future where we are not defined by the colors of the banners we raise, but by that which connects us. A land that we each call home.  
>
...
>
> This land is, after all that has happened...... still Orindia.  

### The History of Orindia (2nd ed.)
Location: Library
Wiki: <https://blue-prince.fandom.com/wiki/The_History_of_Orindia_(2nd_ed.)>
**Borrowers**

| Date       | Borrower         |
| ---------- | ---------------- |
| 1981-02-09 | Herbert Sinclair |
| 1984-01-06 | Mary Jones       |
| 1987-03-02 | Det. Bon Margle  |
| 1987-09-03 | Det. Bon Margle  |
...
>
> Author Caleb Manning Published on  
> 1979 (2nd ed.) Publisher Ruffington Red Publishing  
>
> On the title page, a stamp reads:  
> THIS BOOK WAS REVIEWED AND CLEARED FOR PUBLICATION BY  
> THE  
> FENN ARIES  
...
>
> FOREWARD  
> ████████████████ the name used to designate the realms of the eastern waters. █████████ is no longer ████████████████████████████████████████ known to the average citizen ███████████ █████████████████████████e ████████████████████████████ of the elder generation, ████████████████, █████████████████████████ █████████████ ████ we must █████ ██████████████████ ██████████████████████████████████████ ██████████████ ███████████ permit our leaders to enjoin us to abandon █████████ █████████████ ██████████████████ █████████ our past ███████████████ ██████████████████████████████  
>
> I AJERA  
> Most historians mark the beginning of the first era, often denoted as Ajera, by the ascension of the first king ███████ whose name, Oris, would later grace the burgeoning township in which he was crowned.  
>
> Oris was known, before his coronation, as a prominent merchant lord of considerable means and affluence, whose sway of the region made him the ideal candidate for the unification of the surrounding provinces.  
>
> Regrettably, history is not always forthcoming, and the surviving records of those bygone days are mostly limited to trade agreements and sales receipts.  
>
> Nevertheless, we can deduce from these ledgers that Oris had but one aim: expansion. The territory spread forth from the heart of Oris and by the end of the first century, the ██████████ ███████████████████ ██████████████████ ████████████████████████ ███████████████████████████████████ ██████████████████████████ A new kingdom was born.  
>
> ██████████  
> II SECOND ERA  
> It was the fourth king ████████ who split this vast domain in three equal shares. Three Realms for his three children.  
>
> To the eldest, he granted the fields and mountains of his great grandfather, the middle province and heartspring of the kingdom. The eldest accepted the gift █████████ ████████ █████ █████████████████████████████████ ████████████████████████  
>
> To the youngest, he bestowed upon him the realm of ARCH ARIES, the land of the Northern Storms. A wild and untamed expanse which at the time was not as developed but a good deal more vast than the eldest brother's lot.  
>
> And to his middle child, his only daughter, he gifted her the southern region of ERAJA, ███████████████████ ███████████ a land steeped in tradition, █████████████ ███████████████████████████  
>
> III THIRD ERA  
> As the Second Era drew to a close, the three sovereign realms had achieved a period of remarkable progress and prosperity. Each of these distinct regions, ruled by their respective sibling monarchs, had blossomed, cultivating the bountiful resources of their lands, and developing a unique character and culture that set them apart from one another.  
>
> Despite those differences, the sibling monarchs managed to maintain friendly relations throughout their lives, and were known for their cooperation in matters of trade and transportation. The succeeding generations of their heirs continued that tradition and the Third Era was defined by █████████████ █████████████████████████ ███████████████ ███████████ ███████████ ████████████████ ███████████████████████ ███████████████████ █████████████ ██████ ██████ ███████████████ █████████████████████████████ ██████████████ █████ ████████ commerce between the three realms, further strengthening their bond and laying the foundation for the promise of a prosperous and bright future████ ██████████ █████████ ████████████████████ ███████████ ███████████████████████████  
>
> IV FOURTH ERA  
> As the kingdom█████████████████ entered the fourth era, a different kind of ruler took the reins of power.  
>
> King Desilets III was a ██████████████ ██████████████████████ █████████████████████ ██████████████████████ ████████████████ █████████  
>
> ███████████ king who often was seen ██████████ ████████████████████ drinking ███████████████████ - a sight that shocked not only the gentry and the court, but the masses as well,██████████ ██████████████████████ ██████████████████████████ ████████████████████████████████████  
>
> Desilets was renowned as "The King of █████ ██████████████████████████████████ no one when he made the decision to move ███████████ ████████████████████ ███████████████████████████████ ██████████████████████████████ving castle and court behind. The people were overjoyed by this choice, and ███████████████████████ ███████████ ██████████████████████████ ███████████████ ██████████████████ were those that viewed the king's conduct to be unbecoming of his ██████████████████████████████ █████████████████ ██████████████████████ ████████████████████ common folk.  
>
> These ████████████ voices planted the seed██████ ███████████ which took root in ████████████ █████████████████████████████████████████ █████████████████  
> Grand City of Fenn.  
>
> V ERA of RUIN  
> After the passing of King Desilets III, the Fourth Era came to an abrupt end. Thankfully, the king died ████████████████████ █████████████ █████████████████████ █████████████████████████████ █████████████████████ ██████████████████  
>
...
> However, even with the tide turning in their favor, victory did not come easy. The War of the Fifth Era lasted 22 long years, and saw buried one in every three men. Prince Leerson himself added another number to the casualties. However, even in death, he had won.  
>
> Oris had fallen and with it the realm.  
> The black flags that had flown for five eras were burned, and in their place, red banners were hoisted in honor of the fallen Fenn. The few remaining members of the former royal family fled for their lives to the south, forever exiled.  
>
> VI THE CURRENT ERA  
> Today, the realms inherited by The Three, FENN ARIES, ARCH ARIES, and ERAJA once again stand united as allies. Though the distance between our peoples has grown, our connection to this land remains as strong as ever. The spruce and birch that span across our realms serve as a constant reminder that we all share a common past. ██████████████████████��█████ ████████ ████████████████████████████ ██████████████████████ █████████████████████████████ ████████████████████████ █████████████████████ ██████████████████████ ████████████████████████████████████████████ ███████████████████  
>
> For this, despite everything else, a land rich in history, a land of myth and wonder, a land that sprung for the greatest empire the world has ever seen, the land of our fathers, of our mothers, and of our children.  
>
> ██████████████████████████████████████████  
> ██████████████  
>
> Folded note transcription  
> A letter from Det. Bon Margle to Herbert Sinclair is hidden between the pages on the fourth era.  
>
> Baron Sinclair,  
>
...
Location: Greenhouse
Source: Denny Revane
Wiki: <https://blue-prince.fandom.com/wiki/The_Original_Gardener%27s_Logbook>

Transcript:

> The original GARDENER'S LOGBOOK  
>
> February 1990 - When I get fired  
>
> [Inside cover illustration]  
> A black floral/crest-like emblem appears on the left page with handwritten red annotations on the hanging petals: "she loves me", "she loves me not", "she loves me", "she loves me not".  
>
> [Preface]  
...
> "not many apparently"  
> The printed signature "Denny Revane" is crossed out in red.  
>
> February 25th, 1990  
>
...
>
> [Facing-page illustration and note]  
> A drawing of the flower appears on the facing page.  
>
...
>
> Handwritten red note: "As I suspected, they wanted the flower to serve primarily as a cheap way to produce resources for Special Floorplans."  
>
> October 21st, 1990  
>
...
>
> Handwritten red note beneath a drawing of a wilted potted plant: "I really, really should have."  
>
> January 8th, 1991  
>
...
>
> Handwritten red note: "It’s almost like they were choosing green rooms just to tempt me..."  
>
> [Facing-page diagram]  
> Title: "Antechamber Lever Locations"  
> Labels around a four-door center room diagram:  
> - "Secret Garden" — "Mechanarium"  
> - "Great Hall" — "Secret Garden (sealed)"  
> - "Greenhouse" — "Weight Room (sealed)"  
> A question mark appears above the top side.  
> Caption: "It appears each antechamber door has one primary access lever in addition to a redundancy in another location."  
>
> March 10th, 1991  
>
...
>
> [Facing-page diagram and red annotation]  
> A drawing of the vat and still appears on the facing page.  
> Printed text beneath: "I am unsure if these instruments can be restored to working condition, but if they can, I may yet find a use for the sugar beets and potato stores rotting away in the Root Cellar."  
> Handwritten red note across the illustration: "RESEALED IN JANUARY AFTER DEFECT IN RADIATOR THEN FEB THROUGH APRIL ROUGH"  
>
> August 4th, 1991  
>
...
>
> [Facing-page drawing]  
> A tunnel-like line drawing appears on the facing page with the handwritten label: "Sinclair’s Inner Sanctum".  
>
> August 15th, 1991  
>
...
### The Pool Note
Location: The Pool
Wiki: <https://blue-prince.fandom.com/wiki/The_Pool_Note>
...
> Floorplans added to the Draft Pool are removed at the end of the day.  
> (unless otherwise stated)  
> No Running!  

### The Precipice Mining Logs
Location: The Precipice
Wiki: <https://blue-prince.fandom.com/wiki/The_Precipice_Mining_Logs>
...
> Our exploration, so far, has been limited and entirely superficial as every shaft we have surveyed has ended abruptly and every promising path leading deeper into the mountain has been blocked by tunnels packed tight with soil, rock and debris.  
> This site is either much older than we had first assumed or someone deliberately had these chambers buried.  
> Log 20 Foreman's Log 20 General Spoilers Type Log Location The Precipice Content type Lore Date  
> 25 July 1915 Previous Next [[  
> Log 3  
> ]] [[  
> Log 102  
> ]]  
...
### The Red Prince
Wiki: <https://blue-prince.fandom.com/wiki/The_Red_Prince>
...
> The one that made him happy,  
> Whenever he was sad?  
> A story he had read in the bath and the bed,  
> And maybe you can guess,  
...
> In the Master Bedroom version of the book, a small handwritten note next to the title page reads:  
> P.S. they made me change the ending of course, as you predicted  

### The Red Prince Manuscript
Wiki: <https://blue-prince.fandom.com/wiki/The_Red_Prince_Manuscript>

Transcript:

> # The Red Prince — Full Dual Transcript  
>
> Source: local Blue Prince wiki mirror manuscript images  
> Scope: original black handwritten text vs edited/updated reading with visible editorial markings applied  
>
> ---  
>
> ### Spread 1 (pages 1–2)  
>
> **Left page:**  
> - Original (black text): *(none)*  
> - Edited: same as original  
> - Notes: Page is blank lined notebook paper.  
>
> **Right page:**  
> - Original (black text): `The / Red Prince`  
> - Edited: same as original  
> - Notes: Title is handwritten in **red** ink (the only red text in the manuscript). Lined notebook paper format throughout.  
>
> ---  
>
> ### Spread 2 (pages 3–4)  
...
> **Left page:**  
> - Original (black text):  
>   > ~~Once~~ There was a red prince,  
>   > Who sat on a red throne.  
>   > He had a red crown of rubies,  
>   > And a red castle made of stone.  
> - Edited (with marks applied):  
>   > There was a red prince,  
>   > Who sat on a red throne.  
>   > He had a red crown of rubies,  
>   > And a red castle made of stone.  
> - Notes: "Once" is struck through with a horizontal line (black ink strikethrough). The word "There" immediately follows, suggesting the opening was revised to remove the fairy-tale convention of "Once."  
>
> **Right page:**  
> - Original (black text): *(no text)*  
> - Edited: same as original  
> - Notes: Illustration (black ink/wash) shows a small crowned prince seated on a raised throne, flanked by two armored knights. Candles on stands. Arch doorway behind throne. Grand, formal setting.  
>
> ---  
>
> ### Spread 3 (pages 5–6)  
...
>   > "It's the only true color"  
>   > The prince often said.  
> - Notes: "everything" is struck through (black strikethrough) and "all things" is written directly below it as the replacement. Both strikethrough and insertion appear to be in black ink.  
>
> **Right page:**  
> - Original (black text): *(no text)*  
> - Edited: same as original  
> - Notes: Illustration shows the crowned prince holding an apple, surrounded by red-themed objects (all rendered in greyscale wash): a red wagon, apples, roses, a fire hydrant, a stop sign, a crab/lobster, and a pentagon-shaped box. The prince is collecting or admiring these items.  
>
> ---  
>
> ### Spread 4 (pages 7–8)  
...
>   > Of a swan in the snow.  
> - Edited: same as original  
> - Notes: Three editorial annotation symbols are drawn **above** the words "canary," "crow," and "swan" in black ink:  
>   - Above **"canary"**: the realm symbol for Arch Aries (yellow)  
>   - Above **"crow"**: the realm symbol of Orinda Aries (black)  
>   - Above **"swan"**: the realm symbol of Mora Jai (white)  
>
> **Right page:**  
> - Original (black text): *(no text)*  
> - Edited: same as original  
> - Notes: Illustration shows a large, dark black crow perched prominently on a branch in foliage. To the right, a small crowned figure (the prince) and a lighter-colored bird (dove/swan). The contrast between the dark crow and the light bird is thematic.  
>
> ---  
>
> ### Spread 5 (pages 9–10)  
...
>   > Was not a red hue!  
> - Edited: same as original  
> - Notes: A small hand-drawn swirl/curved arrow is drawn beneath the comma after "sky," appearing to connect or emphasize the line break. This appears to be in black ink — likely an editorial flourish or caret mark, not a text change.  
>
> **Right page:**  
> - Original (black text): *(no text)*  
> - Edited: same as original  
> - Notes: Illustration shows the crowned prince from behind, looking toward a castle in the middle distance surrounded by tall pine/conifer trees. The prince appears small and forlorn, facing away. The sky area is blank (uncolored), emphasizing the theme of not looking up.  
>
> ---  
>
...
> - Edited: same as original  
> - Notes: No corrections or annotations visible on this spread's text page.  
>
> **Right page:**  
> - Original (black text): *(no text)*  
> - Edited: same as original  
> - Notes: Illustration shows an autumn scene — a tree shedding leaves, the crowned prince sitting alone on a park bench, two birds nearby (one on the bench beside him, one on a lamppost). A melancholy, isolated mood. Prince is looking down.  
>
> ---  
>
...
> - Edited: same as original  
> - Notes: **Notably**, the final line shifts to **first person** ("the world **I** had to share") — this is the only such first-person intrusion in the text and may be intentional or an uncorrected slip. No correction marks are present. The line also lacks a terminal period/punctuation, unlike others. This may imply a narrator (the author? a character?) speaking directly.  
>
> **Right page:**  
> - Original (black text): *(no text)*  
> - Edited: same as original  
> - Notes: Illustration shows an interior scene. Foreground: the prince seated in an armchair, reading a large open book. Background: a woman in a Victorian-style dress standing near a birdcage on a stand; an exotic bird (dragon-like/colorful bird) perches on her arm. To the right, an easel/chalkboard displaying a space/planet scene (Saturn-like ringed planet). The presence of the woman and the wider world is notable — she seems to represent the unseen "I" narrator.  
>
> ---  
>
...
> - Edited: same as original  
> - Notes: Indented couplet formatting (alternating lines indented). No corrections visible.  
>
> **Right page:**  
> - Original (black text): *(no text)*  
> - Edited: same as original  
> - Notes: Illustration shows the prince standing in a pine forest, looking at something. **A small blue butterfly** is visible to his right — this is the **first use of blue color** in the entire illustration sequence and stands out dramatically against the all-black-and-grey wash. A dotted trail suggests the butterfly's flight path. The "something new" of the text is visually the blue butterfly.  
>
> ---  
>
...
> - Edited: same as original  
> - Notes: Sentence ends with ellipsis, leading into the final reveal on the next page. No corrections or annotations.  
>
> **Right page:**  
> - Original (black text): *(no text)*  
> - Edited: same as original  
> - Notes: Illustration shows the prince as a tiny figure standing amid large, billowing clouds. The clouds are rendered in grey wash, parting around the figure. The sky behind remains uncolored/white — the color reveal is held for the final page.  
>
> ---  
>
...
>
> **Left page:**  
> - Original (black text): `the color` *(then in blue ink:)* `blue.`  
> - Edited (blue mark applied): `the color blue.`  
> - Notes: **Key editorial/artistic blue marking**: The word **"blue."** is written in **blue ink**, distinct from all other black text in the manuscript. This is the payoff of the story's final reveal. The black text "the color" sets up the line, and "blue." completes it in the color being named. This is simultaneously in-universe (the prince's new favorite color) and a meta-textual moment (the manuscript itself uses blue ink for the first time here).  
>
> **Right page:**  
> - Original (black text): *(no text)*  
> - Edited: same as original  
> - Notes: The illustration is filled with **vivid blue watercolor wash** for the sky — the only full-color illustration in the entire manuscript. White clouds float in the blue sky. The prince stands between two pine trees, looking up at the sky for the first time. The transformation is complete. The blue coloring of this illustration is the visual climax of the story, mirroring the single blue word on the left page.  
>
> ---  
>
> ## Summary Notes  
>
> **Blue markings inventory:**  
> 1. **Spread 10, left page** — Word `"blue."` written in blue ink  
> 2. **Spread 10, right page** — Full blue watercolor fill in illustration (the sky)  
> 3. **Spread 8, right page** — Small blue butterfly in illustration (first hint of blue)  
>
> **Black editorial corrections:**  
> 1. **Spread 2** — "Once" struck through  
> 2. **Spread 3** — "everything" struck through, replaced with "all things" (written below)  
> 3. **Spread 4** — Three symbolic annotation marks above "canary" (△ crown), "crow" (□ rectangle), "swan" (⌢ arch)  
> 4. **Spread 5** — Small swirl/arrow under "sky,"  
>
> **Notable anomaly:**  
> - Spread 7's final line reads "Of the world **I** had to share" — first-person voice, no correction mark. Intentional authorial intrusion. The illustration on that page features a woman who may be the implied narrator/speaker.  
>
> **Puzzle flags:**  
> - `flag:first-person-intrusion` — "the world I had to share" — Mary speaking directly to Simon, direct allusion to political realities of being ruled by Fenn Aries (red)  
> - `flag:color-symbolism` — Red → Blue transformation = political/personal conversion  
> - `flag:blue-butterfly` — First blue element; butterflies = transformation;  

### Tomb Letter
Location: Tomb
Wiki: <https://blue-prince.fandom.com/wiki/Tomb_Letter>
...
> At least for me.  
>
> And of all the picturesque places of this grand estate, I chose this dreary dank dungeon to be laid to rest... And that same dim somber fate fell upon my father and his father before him who loved the outdoors even more than myself. They say there is no stronger bond of servitude than tradition. And family tradition? Thrice as strong. These are chains that seldom bend and never break.  
>
...
>
> Oh, how I wish to have been buried underneath the great oak, overlooking the plains, the wondrous woods and the worldly mountains. And the wild holly that surrounds the trunk, a perpetual token of sympathy laid across my grave. What dreadful tradition is it that dumped me in this sunless hollow?  
>
...
>
> And to, in turn, as recompense for the freedom thus granted you, commit yourself to be buried here. Here, within this mausoleum of dreams, and when the day comes to write your own letter, to inspire the next generation that follows in our footsteps.  
>
> As is tradition,  
> Herbert S. Sinclair  
...
Wiki: <https://blue-prince.fandom.com/wiki/Trading_Post_Note>
...
### Treasure Trove Note 1
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>

Transcript:

> Chest: White / Moon  
> Memo: The green memos you find in this room will always be true.  
> Truth Value: False according to Memo #2 (or Reservoir Memo #17)  
>
> Transcript:  

### Treasure Trove Note 2
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: Blue / Moon  
> Memo: Green memos in white boxes are always lies.  
> Truth Value: True  
>
> Transcript:  

### Treasure Trove Note 3
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: Blue / Sun  
> Memo: The true treasure of the trove is not in the house.  
> Truth Value: True according to Memo #4 (or Reservoir Memo #22)  
>
> Transcript:  

### Treasure Trove Note 4
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: White / Flame  
> Memo: The previous box in this room contained a true statement.  
> Truth Value: True  
>
> Transcript:  

### Treasure Trove Note 5
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: White / Flame  
> Memo: Two realms have the same color banner.  
> Truth Value: False according to Memo #2  
>
> Transcript:  

### Treasure Trove Note 6
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: Black / Moon  
> Memo: Boxes marked with Moon always contain false statements.  
> Truth Value: False as it would contradict itself if true.  
>
> Transcript:  

### Treasure Trove Note 7
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: White / Flame  
> Memo: The true treasure of the trove is not in this room.  
> Truth Value: False  
>
> Transcript:  

### Treasure Trove Note 8
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: Black / Sun  
> Memo: All boxes marked by Sun contain memos that are true.  
> Truth Value: True  
>
> Transcript:  

### Treasure Trove Note 9
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: Blue / Moon  
> Memo: Pink boxes marked with Moon always contain false statements.  
> Truth Value: True according to Memo #14 (or Reservoir Memo #11)  
>
> Transcript:  

### Treasure Trove Note 10
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: Pink / Moon  
> Memo: There is no realm that flies the white flag.  
> Truth Value: False according to Memo #9, but would be true if "white" was changed to "blue"  
>
> Transcript:  

### Treasure Trove Note 11
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: Black / Sun  
> Memo: You will need a key to obtain the true treasure of the trove.  
> Truth Value: True according to Memo #8  
>
> Transcript:  

### Treasure Trove Note 13
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: Blue / Moon  
> Memo: Blue boxes marked by Flame contain false statements.  
> Truth Value: True  
>
> Transcript:  

### Treasure Trove Note 14
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: White / Flame  
> Memo: Green memos in blue boxes are sometimes false.  
> Truth Value: False  
>
> Transcript:  

### Treasure Trove Note 15
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: Blue / Moon  
> Memo: Fenn Aries  
> Truth Value: True according to Memo #14  
>
> Transcript:  
> borders a poetic realm.  

### Treasure Trove Note 16
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: White / Flame  
> Memo: It never rains in  
> Truth Value: False according to Memo #2  
>
> Transcript:  
> Arch Aries .  

### Treasure Trove Note 17
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: White / Sun  
> Memo: Green memos in pink boxes are always false.  
> Truth Value: True  
>
> Transcript:  

### Treasure Trove Note 18
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: Pink / Moon  
> Memo: You have seen all the memos that appear in this room.  
> Truth Value: False according to Memo #17  
>
> Transcript:  

### Treasure Trove Note 19
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: Blue / Sun  
> Memo: The next four boxes marked by Moon contain false statements.  
> Truth Value: True  
>
> Transcript:  

### Treasure Trove Note 20
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: Pink / Flame  
> Memo: Red memos in blue boxes are always true.  
> Truth Value: False according to Memo #17, but would be true if "red" was changed to "green"  
>
> Transcript:  

### Treasure Trove Note 21
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: White / Flame  
> Memo: Green (handwritten)  
> Truth Value: False according to Memo #21, but would be true if "green" was changed to "blue"  
>
> Transcript:  
> The next three green memos you find in this room will all be true.  

### Treasure Trove Note 23
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
>
> Transcript:  
> The symbol "∞" is used to denote the unknown, death, and the number 8.  

### Treasure Trove Note 25
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
>
> Transcript:  
> There is an antechamber lever hidden in the drawing room .  

### Treasure Trove Note 30
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
>
> Transcript:  
> The baron began and ended his travels in the same realm.  

### Treasure Trove Note 31
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
>
> Transcript:  
> Nuance is known to be a peaceful realm.  

### Treasure Trove Note 32
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: Black / Flame  
> Memo: Green (handwritten)  
> Truth Value: False according to Memo #21, but would be true if "red" was changed to "blue"  
>
> Transcript:  
> The family core can be found in a red room with a 5-letter name.  

### Treasure Trove Note 35
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
>
> Transcript:  
> Yenna means both rain and ruler in Erajan.  

### Treasure Trove Note 37
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
>
> Transcript:  
> There are secrets in the rooms you drain.  

### Treasure Trove Note 38
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: Black / Moon  
> Memo: Green  
> Truth Value: False according to Memo #39  
>
> Transcript:  
> You must don the mantle of the knight to perform the ritual of castling.  

### Treasure Trove Note 39
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
>
> Transcript:  
> Page six of " A New Clue " hides a secret.  

### Treasure Trove Note 41
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
>
> Transcript:  
> Ein means dream in Erajan.  

### Treasure Trove Note 42
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
> Chest: White / Flame  
> Memo: Green (handwritten)  
> Truth Value: False according to Memo #21, but would be true if "red" was changed to "green"  
>
> Transcript:  
> A secret door lies hidden in the red house.  

### Treasure Trove Note 43
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
>
> Transcript:  
> The true treasure of the trove is in this room but is not in the house.  

### Treasure Trove Note 44
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
>
> Transcript:  
> The monk waits beyond the second chamber.  

### Treasure Trove Note 45
Location: Treasure Trove
Wiki: <https://blue-prince.fandom.com/wiki/Treasure_Trove_Notes>
...
Wiki: <https://blue-prince.fandom.com/wiki/Tunnel_Mining_Log>
...
Wiki: <https://blue-prince.fandom.com/wiki/West_Wing_Hall_Note>
